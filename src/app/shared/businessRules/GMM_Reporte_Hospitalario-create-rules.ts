...
export class GMM_Reporte_HospitalarioCreateRules {
  ...
  rulesOnInit(formGroup: FormGroup, parameters?: any[]) {
    ...
    setTimeout(() => {
      ...
      this.brf.applyConditionsToControl(formGroup, 'Empleado', false, false, false);
      this.brf.applyConditionsToControl(formGroup, 'Asegurado', false, false, false);
    }, 0);
  }

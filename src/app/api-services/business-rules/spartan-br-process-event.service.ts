...
export class SpartanBrProcessEventService {

  private readonly API_URL = 'api/spartan_br_process_event/';
  ...
  GetAll() {
    ...
    return this.http.get<Array<Spartan_BR_Process_Event_Model>>(environment.endpoints.WebApi + this.API_URL + 'GetAll', { headers: this.buildGetHeaders() }).
    pipe(
       map((data: Array<Spartan_BR_Process_Event_Model>) => {
         return data;
       }), 
       catchError( error => {
        //console.log('ProcessEvent_Error', error);
  ...
  GetAllComplete() {
    ...
    return this.http.get<Array<Spartan_BR_Process_Event_Model>>(environment.endpoints.WebApi + this.API_URL + 'GetAllComplete', { headers: this.buildGetHeaders() }).
    pipe(
       map((data: Array<Spartan_BR_Process_Event_Model>) => {
         return data;
       }), 
  ...
  ListaSelAll(startRowIndex: number, maximumRows: number, where: string, order: string) {
    ...
    return this.http.get<Array<Spartan_BR_Process_Event_Model>>(

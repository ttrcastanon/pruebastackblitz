...
import { Modulos_reportesRoutingModule } from '../Modulos_reportes/Modulos_reportes-routing.module';
...
@NgModule({
  declarations: [Modulos_reportesComponent,
    ListModulos_reportesComponent,
    ShowAdvanceFilterModulos_reportesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Modulos_reportesModule { }

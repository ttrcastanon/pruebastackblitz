...
import { Tipo_de_Documentacion_PAXsRoutingModule } from '../Tipo_de_Documentacion_PAXs/Tipo_de_Documentacion_PAXs-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Documentacion_PAXsComponent,
    ListTipo_de_Documentacion_PAXsComponent,
    ShowAdvanceFilterTipo_de_Documentacion_PAXsComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Documentacion_PAXsRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Documentacion_PAXsModule { }

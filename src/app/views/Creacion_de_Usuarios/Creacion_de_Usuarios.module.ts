...
import { Creacion_de_UsuariosRoutingModule } from '../Creacion_de_Usuarios/Creacion_de_Usuarios-routing.module';
...
@NgModule({
  declarations: [Creacion_de_UsuariosComponent,
    ListCreacion_de_UsuariosComponent,
    ShowAdvanceFilterCreacion_de_UsuariosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Creacion_de_UsuariosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
...
export class Creacion_de_UsuariosModule { }

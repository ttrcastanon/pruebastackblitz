...
import { Tipo_ConceptoRoutingModule } from '../Tipo_Concepto/Tipo_Concepto-routing.module';
...
@NgModule({
  declarations: [Tipo_ConceptoComponent,
    ListTipo_ConceptoComponent,
    ShowAdvanceFilterTipo_ConceptoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_ConceptoModule { }

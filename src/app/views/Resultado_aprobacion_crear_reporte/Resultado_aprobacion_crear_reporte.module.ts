...
import { Resultado_aprobacion_crear_reporteRoutingModule } from '../Resultado_aprobacion_crear_reporte/Resultado_aprobacion_crear_reporte-routing.module';
...
@NgModule({
  declarations: [Resultado_aprobacion_crear_reporteComponent,
    ListResultado_aprobacion_crear_reporteComponent,
    ShowAdvanceFilterResultado_aprobacion_crear_reporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Resultado_aprobacion_crear_reporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Resultado_aprobacion_crear_reporteModule { }

...
import { Turbulencia_de_EstelaRoutingModule } from '../Turbulencia_de_Estela/Turbulencia_de_Estela-routing.module';
...
@NgModule({
  declarations: [Turbulencia_de_EstelaComponent,
    ListTurbulencia_de_EstelaComponent,
    ShowAdvanceFilterTurbulencia_de_EstelaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Turbulencia_de_EstelaRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Turbulencia_de_EstelaModule { }

...
import { Tipo_de_origen_del_reporteRoutingModule } from '../Tipo_de_origen_del_reporte/Tipo_de_origen_del_reporte-routing.module';
...
@NgModule({
  declarations: [Tipo_de_origen_del_reporteComponent,
    ListTipo_de_origen_del_reporteComponent,
    ShowAdvanceFilterTipo_de_origen_del_reporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_origen_del_reporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_origen_del_reporteModule { }

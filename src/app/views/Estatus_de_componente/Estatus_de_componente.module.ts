...
import { Estatus_de_componenteRoutingModule } from '../Estatus_de_componente/Estatus_de_componente-routing.module';
...
@NgModule({
  declarations: [Estatus_de_componenteComponent,
    ListEstatus_de_componenteComponent,
    ShowAdvanceFilterEstatus_de_componenteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_componenteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_componenteModule { }

...
import { Tipo_de_ClienteRoutingModule } from '../Tipo_de_Cliente/Tipo_de_Cliente-routing.module';
...
@NgModule({
  declarations: [Tipo_de_ClienteComponent,
    ListTipo_de_ClienteComponent,
    ShowAdvanceFilterTipo_de_ClienteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_ClienteModule { }

...
import { Tipo_de_Servicios_AduanalesRoutingModule } from '../Tipo_de_Servicios_Aduanales/Tipo_de_Servicios_Aduanales-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Servicios_AduanalesComponent,
    ListTipo_de_Servicios_AduanalesComponent,
    ShowAdvanceFilterTipo_de_Servicios_AduanalesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Servicios_AduanalesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Servicios_AduanalesModule { }

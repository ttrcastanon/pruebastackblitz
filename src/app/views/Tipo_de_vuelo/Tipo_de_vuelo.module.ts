...
import { Tipo_de_vueloRoutingModule } from '../Tipo_de_vuelo/Tipo_de_vuelo-routing.module';
...
@NgModule({
  declarations: [Tipo_de_vueloComponent,
    ListTipo_de_vueloComponent,
    ShowAdvanceFilterTipo_de_vueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_vueloModule { }

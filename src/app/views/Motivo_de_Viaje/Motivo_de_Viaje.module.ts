...
import { Motivo_de_ViajeRoutingModule } from '../Motivo_de_Viaje/Motivo_de_Viaje-routing.module';
...
@NgModule({
  declarations: [Motivo_de_ViajeComponent,
    ListMotivo_de_ViajeComponent,
    ShowAdvanceFilterMotivo_de_ViajeComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Motivo_de_ViajeModule { }

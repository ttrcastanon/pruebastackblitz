...
import { Husos_de_horariosRoutingModule } from '../Husos_de_horarios/Husos_de_horarios-routing.module';
...
@NgModule({
  declarations: [Husos_de_horariosComponent,
    ListHusos_de_horariosComponent,
    ShowAdvanceFilterHusos_de_horariosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Husos_de_horariosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Husos_de_horariosModule { }

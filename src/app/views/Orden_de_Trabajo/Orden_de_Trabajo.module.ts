...
import { Orden_de_TrabajoRoutingModule } from '../Orden_de_Trabajo/Orden_de_Trabajo-routing.module';
...
@NgModule({
  declarations: [Orden_de_TrabajoComponent,
    ListOrden_de_TrabajoComponent,
    ShowAdvanceFilterOrden_de_TrabajoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Orden_de_TrabajoModule { }

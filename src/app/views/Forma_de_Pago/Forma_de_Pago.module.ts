...
import { Forma_de_PagoRoutingModule } from '../Forma_de_Pago/Forma_de_Pago-routing.module';
...
@NgModule({
  declarations: [Forma_de_PagoComponent,
    ListForma_de_PagoComponent,
    ShowAdvanceFilterForma_de_PagoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Forma_de_PagoModule { }

...
import { Notificaciones_PushRoutingModule } from '../Notificaciones_Push/Notificaciones_Push-routing.module';
...
@NgModule({
  declarations: [Notificaciones_PushComponent,
    ListNotificaciones_PushComponent,
    ShowAdvanceFilterNotificaciones_PushComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Notificaciones_PushRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Notificaciones_PushModule { }

...
import { Piezas_RequeridasRoutingModule } from '../Piezas_Requeridas/Piezas_Requeridas-routing.module';
...
@NgModule({
  declarations: [Piezas_RequeridasComponent,
    ListPiezas_RequeridasComponent,
    ShowAdvanceFilterPiezas_RequeridasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Piezas_RequeridasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Piezas_RequeridasModule { }

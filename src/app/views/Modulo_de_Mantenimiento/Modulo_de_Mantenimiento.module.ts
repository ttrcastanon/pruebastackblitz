...
import { Modulo_de_MantenimientoRoutingModule } from '../Modulo_de_Mantenimiento/Modulo_de_Mantenimiento-routing.module';
...
@NgModule({
  declarations: [Modulo_de_MantenimientoComponent,
    ListModulo_de_MantenimientoComponent,
    ShowAdvanceFilterModulo_de_MantenimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Modulo_de_MantenimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Modulo_de_MantenimientoModule { }

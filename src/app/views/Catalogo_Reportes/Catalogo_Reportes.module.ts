...
import { Catalogo_ReportesRoutingModule } from '../Catalogo_Reportes/Catalogo_Reportes-routing.module';
...
@NgModule({
  declarations: [Catalogo_ReportesComponent,
    ListCatalogo_ReportesComponent,
    ShowAdvanceFilterCatalogo_ReportesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Catalogo_ReportesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Catalogo_ReportesModule { }

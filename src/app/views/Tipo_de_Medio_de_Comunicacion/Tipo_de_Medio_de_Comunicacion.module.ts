...
import { Tipo_de_Medio_de_ComunicacionRoutingModule } from '../Tipo_de_Medio_de_Comunicacion/Tipo_de_Medio_de_Comunicacion-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Medio_de_ComunicacionComponent,
    ListTipo_de_Medio_de_ComunicacionComponent,
    ShowAdvanceFilterTipo_de_Medio_de_ComunicacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Medio_de_ComunicacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Medio_de_ComunicacionModule { }

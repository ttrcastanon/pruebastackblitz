...
import { Tipo_Concepto_Estado_ResultadoRoutingModule } from '../Tipo_Concepto_Estado_Resultado/Tipo_Concepto_Estado_Resultado-routing.module';
...
@NgModule({
  declarations: [Tipo_Concepto_Estado_ResultadoComponent,
    ListTipo_Concepto_Estado_ResultadoComponent,
    ShowAdvanceFilterTipo_Concepto_Estado_ResultadoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_Concepto_Estado_ResultadoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_Concepto_Estado_ResultadoModule { }

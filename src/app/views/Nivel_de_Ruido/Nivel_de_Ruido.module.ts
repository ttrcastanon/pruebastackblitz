...
import { Nivel_de_RuidoRoutingModule } from '../Nivel_de_Ruido/Nivel_de_Ruido-routing.module';
...
@NgModule({
  declarations: [Nivel_de_RuidoComponent,
    ListNivel_de_RuidoComponent,
    ShowAdvanceFilterNivel_de_RuidoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Nivel_de_RuidoModule { }

...
import { Listado_de_Directivas_de_aeronavegabilidadRoutingModule } from '../Listado_de_Directivas_de_aeronavegabilidad/Listado_de_Directivas_de_aeronavegabilidad-routing.module';
...
@NgModule({
  declarations: [Listado_de_Directivas_de_aeronavegabilidadComponent,
    ListListado_de_Directivas_de_aeronavegabilidadComponent,
    ShowAdvanceFilterListado_de_Directivas_de_aeronavegabilidadComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_de_Directivas_de_aeronavegabilidadRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_de_Directivas_de_aeronavegabilidadModule { }

...
import { Concepto_de_Gasto_de_EmpleadoRoutingModule } from '../Concepto_de_Gasto_de_Empleado/Concepto_de_Gasto_de_Empleado-routing.module';
...
@NgModule({
  declarations: [Concepto_de_Gasto_de_EmpleadoComponent,
    ListConcepto_de_Gasto_de_EmpleadoComponent,
    ShowAdvanceFilterConcepto_de_Gasto_de_EmpleadoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Concepto_de_Gasto_de_EmpleadoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Concepto_de_Gasto_de_EmpleadoModule { }

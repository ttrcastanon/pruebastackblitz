...
import { Control_de_ComponentesRoutingModule } from '../Control_de_Componentes/Control_de_Componentes-routing.module';
...
@NgModule({
  declarations: [Control_de_ComponentesComponent,
    ListControl_de_ComponentesComponent,
    ShowAdvanceFilterControl_de_ComponentesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Control_de_ComponentesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Control_de_ComponentesModule { }

...
import { Estatus_TripulacionRoutingModule } from '../Estatus_Tripulacion/Estatus_Tripulacion-routing.module';
...
@NgModule({
  declarations: [Estatus_TripulacionComponent,
    ListEstatus_TripulacionComponent,
    ShowAdvanceFilterEstatus_TripulacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_TripulacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_TripulacionModule { }

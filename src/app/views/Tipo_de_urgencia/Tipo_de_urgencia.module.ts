...
import { Tipo_de_urgenciaRoutingModule } from '../Tipo_de_urgencia/Tipo_de_urgencia-routing.module';
...
@NgModule({
  declarations: [Tipo_de_urgenciaComponent,
    ListTipo_de_urgenciaComponent,
    ShowAdvanceFilterTipo_de_urgenciaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_urgenciaModule { }

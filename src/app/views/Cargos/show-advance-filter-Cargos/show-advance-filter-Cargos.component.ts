...
@Component({
  selector: 'app-show-advance-filter-Cargos',
  templateUrl: './show-advance-filter-Cargos.component.html',
  styleUrls: ['./show-advance-filter-Cargos.component.scss']
})
export class ShowAdvanceFilterCargosComponent implements OnInit, AfterViewInit {
  ...
  buscar() {
    ...
    this.dataListConfig.filterAdvanced.fromRole_ID = entity.fromRole_ID;
    this.dataListConfig.filterAdvanced.toRole_ID = entity.toRole_ID;

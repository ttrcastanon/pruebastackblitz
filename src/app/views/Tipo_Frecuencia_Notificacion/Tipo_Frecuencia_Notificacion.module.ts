...
import { Tipo_Frecuencia_NotificacionRoutingModule } from '../Tipo_Frecuencia_Notificacion/Tipo_Frecuencia_Notificacion-routing.module';
...
@NgModule({
  declarations: [Tipo_Frecuencia_NotificacionComponent,
    ListTipo_Frecuencia_NotificacionComponent,
    ShowAdvanceFilterTipo_Frecuencia_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_Frecuencia_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_Frecuencia_NotificacionModule { }

...
import { Solicitud_de_cotizacionRoutingModule } from '../Solicitud_de_cotizacion/Solicitud_de_cotizacion-routing.module';
...
@NgModule({
  declarations: [Solicitud_de_cotizacionComponent,
    ListSolicitud_de_cotizacionComponent,
    ShowAdvanceFilterSolicitud_de_cotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Solicitud_de_cotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
    NgSelectModule
  ],
...
export class Solicitud_de_cotizacionModule { }

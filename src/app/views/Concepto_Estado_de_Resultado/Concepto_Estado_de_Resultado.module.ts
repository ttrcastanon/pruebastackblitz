...
import { Concepto_Estado_de_ResultadoRoutingModule } from '../Concepto_Estado_de_Resultado/Concepto_Estado_de_Resultado-routing.module';
...
@NgModule({
  declarations: [Concepto_Estado_de_ResultadoComponent,
    ListConcepto_Estado_de_ResultadoComponent,
    ShowAdvanceFilterConcepto_Estado_de_ResultadoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Concepto_Estado_de_ResultadoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Concepto_Estado_de_ResultadoModule { }

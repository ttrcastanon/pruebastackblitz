...
import { Documentacion_de_AeronaveRoutingModule } from '../Documentacion_de_Aeronave/Documentacion_de_Aeronave-routing.module';
...
@NgModule({
  declarations: [Documentacion_de_AeronaveComponent,
    ListDocumentacion_de_AeronaveComponent,
    ShowAdvanceFilterDocumentacion_de_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Documentacion_de_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Documentacion_de_AeronaveModule { }

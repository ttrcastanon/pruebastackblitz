...
import { Pago_de_servicios_de_operacionesRoutingModule } from '../Pago_de_servicios_de_operaciones/Pago_de_servicios_de_operaciones-routing.module';
...
@NgModule({
  declarations: [Pago_de_servicios_de_operacionesComponent,
    ListPago_de_servicios_de_operacionesComponent,
    ShowAdvanceFilterPago_de_servicios_de_operacionesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Pago_de_servicios_de_operacionesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Pago_de_servicios_de_operacionesModule { }

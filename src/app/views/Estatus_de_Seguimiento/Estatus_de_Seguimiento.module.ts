...
import { Estatus_de_SeguimientoRoutingModule } from '../Estatus_de_Seguimiento/Estatus_de_Seguimiento-routing.module';
...
@NgModule({
  declarations: [Estatus_de_SeguimientoComponent,
    ListEstatus_de_SeguimientoComponent,
    ShowAdvanceFilterEstatus_de_SeguimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_SeguimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_SeguimientoModule { }

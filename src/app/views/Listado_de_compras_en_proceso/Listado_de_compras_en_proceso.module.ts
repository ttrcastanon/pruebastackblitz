...
import { Listado_de_compras_en_procesoRoutingModule } from '../Listado_de_compras_en_proceso/Listado_de_compras_en_proceso-routing.module';
...
@NgModule({
  declarations: [Listado_de_compras_en_procesoComponent,
    ListListado_de_compras_en_procesoComponent,
    ShowAdvanceFilterListado_de_compras_en_procesoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_de_compras_en_procesoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_de_compras_en_procesoModule { }

...
import { Seguros_Asociados_a_la_AeronaveRoutingModule } from '../Seguros_Asociados_a_la_Aeronave/Seguros_Asociados_a_la_Aeronave-routing.module';
...
@NgModule({
  declarations: [Seguros_Asociados_a_la_AeronaveComponent,
    ListSeguros_Asociados_a_la_AeronaveComponent,
    ShowAdvanceFilterSeguros_Asociados_a_la_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Seguros_Asociados_a_la_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Seguros_Asociados_a_la_AeronaveModule { }

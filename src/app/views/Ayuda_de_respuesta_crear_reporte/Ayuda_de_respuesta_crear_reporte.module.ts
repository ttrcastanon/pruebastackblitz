...
import { Ayuda_de_respuesta_crear_reporteRoutingModule } from '../Ayuda_de_respuesta_crear_reporte/Ayuda_de_respuesta_crear_reporte-routing.module';
...
@NgModule({
  declarations: [Ayuda_de_respuesta_crear_reporteComponent,
    ListAyuda_de_respuesta_crear_reporteComponent,
    ShowAdvanceFilterAyuda_de_respuesta_crear_reporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Ayuda_de_respuesta_crear_reporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Ayuda_de_respuesta_crear_reporteModule { }

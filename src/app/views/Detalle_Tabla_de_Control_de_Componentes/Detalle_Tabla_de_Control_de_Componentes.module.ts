...
import { Detalle_Tabla_de_Control_de_ComponentesRoutingModule } from '../Detalle_Tabla_de_Control_de_Componentes/Detalle_Tabla_de_Control_de_Componentes-routing.module';
...
@NgModule({
  declarations: [Detalle_Tabla_de_Control_de_ComponentesComponent,
    ListDetalle_Tabla_de_Control_de_ComponentesComponent,
    ShowAdvanceFilterDetalle_Tabla_de_Control_de_ComponentesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Detalle_Tabla_de_Control_de_ComponentesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Detalle_Tabla_de_Control_de_ComponentesModule { }

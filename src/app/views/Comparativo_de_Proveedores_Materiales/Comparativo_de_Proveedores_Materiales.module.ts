...
import { Comparativo_de_Proveedores_MaterialesRoutingModule } from '../Comparativo_de_Proveedores_Materiales/Comparativo_de_Proveedores_Materiales-routing.module';
...
@NgModule({
  declarations: [Comparativo_de_Proveedores_MaterialesComponent,
    ListComparativo_de_Proveedores_MaterialesComponent,
    ShowAdvanceFilterComparativo_de_Proveedores_MaterialesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Comparativo_de_Proveedores_MaterialesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Comparativo_de_Proveedores_MaterialesModule { }

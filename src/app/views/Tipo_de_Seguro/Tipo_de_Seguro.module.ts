...
import { Tipo_de_SeguroRoutingModule } from '../Tipo_de_Seguro/Tipo_de_Seguro-routing.module';
...
@NgModule({
  declarations: [Tipo_de_SeguroComponent,
    ListTipo_de_SeguroComponent,
    ShowAdvanceFilterTipo_de_SeguroComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_SeguroModule { }

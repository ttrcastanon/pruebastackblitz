...
import { Estatus_de_ProveedorRoutingModule } from '../Estatus_de_Proveedor/Estatus_de_Proveedor-routing.module';
...
@NgModule({
  declarations: [Estatus_de_ProveedorComponent,
    ListEstatus_de_ProveedorComponent,
    ShowAdvanceFilterEstatus_de_ProveedorComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_ProveedorRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_ProveedorModule { }

...
import { Tipo_de_TripulanteRoutingModule } from '../Tipo_de_Tripulante/Tipo_de_Tripulante-routing.module';
...
@NgModule({
  declarations: [Tipo_de_TripulanteComponent,
    ListTipo_de_TripulanteComponent,
    ShowAdvanceFilterTipo_de_TripulanteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_TripulanteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_TripulanteModule { }

...
import { Ingreso_de_CostosRoutingModule } from '../Ingreso_de_Costos/Ingreso_de_Costos-routing.module';
...
@NgModule({
  declarations: [Ingreso_de_CostosComponent,
    ListIngreso_de_CostosComponent,
    ShowAdvanceFilterIngreso_de_CostosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Ingreso_de_CostosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Ingreso_de_CostosModule { }

...
import { Layout_ProveedoresRoutingModule } from '../Layout_Proveedores/Layout_Proveedores-routing.module';
...
@NgModule({
  declarations: [Layout_ProveedoresComponent,
    ListLayout_ProveedoresComponent,
    ShowAdvanceFilterLayout_ProveedoresComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Layout_ProveedoresRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Layout_ProveedoresModule { }

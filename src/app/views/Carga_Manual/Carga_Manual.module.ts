...
import { Carga_ManualRoutingModule } from '../Carga_Manual/Carga_Manual-routing.module';
...
@NgModule({
  declarations: [Carga_ManualComponent,
    ListCarga_ManualComponent,
    ShowAdvanceFilterCarga_ManualComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Carga_ManualModule { }

...
import { Detalle_Cursos_PasajerosRoutingModule } from '../Detalle_Cursos_Pasajeros/Detalle_Cursos_Pasajeros-routing.module';
...
@NgModule({
  declarations: [Detalle_Cursos_PasajerosComponent,
    ListDetalle_Cursos_PasajerosComponent,
    ShowAdvanceFilterDetalle_Cursos_PasajerosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Detalle_Cursos_PasajerosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Detalle_Cursos_PasajerosModule { }

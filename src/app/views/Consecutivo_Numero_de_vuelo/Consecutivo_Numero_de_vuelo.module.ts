...
import { Consecutivo_Numero_de_vueloRoutingModule } from '../Consecutivo_Numero_de_vuelo/Consecutivo_Numero_de_vuelo-routing.module';
...
@NgModule({
  declarations: [Consecutivo_Numero_de_vueloComponent,
    ListConsecutivo_Numero_de_vueloComponent,
    ShowAdvanceFilterConsecutivo_Numero_de_vueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Consecutivo_Numero_de_vueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Consecutivo_Numero_de_vueloModule { }

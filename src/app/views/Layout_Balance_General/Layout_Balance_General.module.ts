...
import { Layout_Balance_GeneralRoutingModule } from '../Layout_Balance_General/Layout_Balance_General-routing.module';
...
@NgModule({
  declarations: [Layout_Balance_GeneralComponent,
    ListLayout_Balance_GeneralComponent,
    ShowAdvanceFilterLayout_Balance_GeneralComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Layout_Balance_GeneralRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Layout_Balance_GeneralModule { }

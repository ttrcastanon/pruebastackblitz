...
import { Resultado_de_Autorizacion_de_VueloRoutingModule } from '../Resultado_de_Autorizacion_de_Vuelo/Resultado_de_Autorizacion_de_Vuelo-routing.module';
...
@NgModule({
  declarations: [Resultado_de_Autorizacion_de_VueloComponent,
    ListResultado_de_Autorizacion_de_VueloComponent,
    ShowAdvanceFilterResultado_de_Autorizacion_de_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Resultado_de_Autorizacion_de_VueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Resultado_de_Autorizacion_de_VueloModule { }

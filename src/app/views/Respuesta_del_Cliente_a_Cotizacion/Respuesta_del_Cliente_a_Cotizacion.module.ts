...
import { Respuesta_del_Cliente_a_CotizacionRoutingModule } from '../Respuesta_del_Cliente_a_Cotizacion/Respuesta_del_Cliente_a_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Respuesta_del_Cliente_a_CotizacionComponent,
    ListRespuesta_del_Cliente_a_CotizacionComponent,
    ShowAdvanceFilterRespuesta_del_Cliente_a_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Respuesta_del_Cliente_a_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Respuesta_del_Cliente_a_CotizacionModule { }

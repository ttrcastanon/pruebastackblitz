...
import { Salida_en_almacenRoutingModule } from '../Salida_en_almacen/Salida_en_almacen-routing.module';
...
@NgModule({
  declarations: [Salida_en_almacenComponent,
    ListSalida_en_almacenComponent,
    ShowAdvanceFilterSalida_en_almacenComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Salida_en_almacenRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Salida_en_almacenModule { }

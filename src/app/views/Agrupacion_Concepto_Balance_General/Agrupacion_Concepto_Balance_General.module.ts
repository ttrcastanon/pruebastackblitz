...
import { Agrupacion_Concepto_Balance_GeneralRoutingModule } from '../Agrupacion_Concepto_Balance_General/Agrupacion_Concepto_Balance_General-routing.module';
...
@NgModule({
  declarations: [Agrupacion_Concepto_Balance_GeneralComponent,
    ListAgrupacion_Concepto_Balance_GeneralComponent,
    ShowAdvanceFilterAgrupacion_Concepto_Balance_GeneralComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Agrupacion_Concepto_Balance_GeneralRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Agrupacion_Concepto_Balance_GeneralModule { }

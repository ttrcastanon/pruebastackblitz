...
import { Calendario_ConfiguracionRoutingModule } from '../Calendario_Configuracion/Calendario_Configuracion-routing.module';
...
@NgModule({
  declarations: [Calendario_ConfiguracionComponent,
    ListCalendario_ConfiguracionComponent,
    ShowAdvanceFilterCalendario_ConfiguracionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Calendario_ConfiguracionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Calendario_ConfiguracionModule { }

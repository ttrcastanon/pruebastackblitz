...
import { Coord__de_Vuelo__TripulacionIndexRules } from 'src/app/shared/businessRules/Coord__de_Vuelo__Tripulacion-index-rules';
...
@Component({
  selector: "app-list-Coord__de_Vuelo__Tripulacion",
  templateUrl: "./list-Coord__de_Vuelo__Tripulacion.component.html",
  styleUrls: ["./list-Coord__de_Vuelo__Tripulacion.component.scss"],
})
export class ListCoord__de_Vuelo__TripulacionComponent extends Coord__de_Vuelo__TripulacionIndexRules implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  dataSource: Coord__de_Vuelo__TripulacionDataSource | null;
  @ViewChild(MatPaginator) paginator: MatPaginator;
  @ViewChild(MatSort) sort: MatSort;

  dataSourceTemp: Coord__de_Vuelo__TripulacionDataSource;
  dataClipboard: any;

  constructor(
    private _Coord__de_Vuelo__TripulacionService: Coord__de_Vuelo__TripulacionService,
  ...
  ngOnInit() {
    ...
    this.dataSource = new Coord__de_Vuelo__TripulacionDataSource(
      this._Coord__de_Vuelo__TripulacionService, this._file
    );
    this.init();
    this._seguridad
...
//Fin de reglas
  ...
  remove(row: Coord__de_Vuelo__Tripulacion) {
    this._messages
      .confirmation(
      ...
      .then(() => {
        ...
        this._Coord__de_Vuelo__TripulacionService
          .delete(+row.Folio)
          .pipe(
            catchError(() => of([])),
   ...
   */
  ActionPrint(dataRow: Coord__de_Vuelo__Tripulacion) {
...
,x.Observaciones
    ...
    pdfMake.createPdf(pdfDefinition).download('Coord__de_Vuelo__Tripulacion.pdf');
  }
    ...
    this.dialogo
      ...
      .subscribe((optionSelected: string) => {
        ...
        if (optionSelected == '1') {
          ...
          this._Coord__de_Vuelo__TripulacionService.listaSelAll(starRowIndex, maximumRows, condition, sort)
            .subscribe((response: any) => {
              this.dataSourceTemp = response.Coord__de_Vuelo__Tripulacions;
          ...
          this._Coord__de_Vuelo__TripulacionService.listaSelAll(1, 9999, '', '')
            .subscribe((response: any) => {
              this.dataSourceTemp = response.Coord__de_Vuelo__Tripulacions;
              const dataToRender = this.SetTableExport(this.dataSourceTemp);
  ...
  ExportToExcel(data: any) {
    ...
    this.excelService.exportAsExcelFile(excelData, `Coord__de_Vuelo__Tripulacion  ${new Date().toLocaleString()}`);
  }
  ...
  ExportToCSV(data: any) {
    ...
    this.excelService.exportToCsv(result, 'Coord__de_Vuelo__Tripulacion',  ['Folio'    ,'Numero_de_Vuelo'  ,'Matricula'  ,'Ruta_de_Vuelo'  ,'Fecha_y_Hora_de_Salida'  ,'Calificacion'  ,'Observaciones' ]);
  }
...
export class Coord__de_Vuelo__TripulacionDataSource implements DataSource<Coord__de_Vuelo__Tripulacion>
{
  private subject = new BehaviorSubject<Coord__de_Vuelo__Tripulacion[]>([]);
  ...
  constructor(private service: Coord__de_Vuelo__TripulacionService, private _file: SpartanFileService) { }

  connect(
    collectionViewer: CollectionViewer
  ): Observable<Coord__de_Vuelo__Tripulacion[]> {
...
if (data.MRWhere.length > 0){
      ...
      .subscribe((result: any) => {
        ...
        data.columns.forEach((column, index) => {
          if (column === 'Folio') { // Clave primaria
            ...
            try {
              const longest = result.Coord__de_Vuelo__Tripulacions.map(x => (x[column]) ? x[column].toString() : '').sort((a, b) => b.length - a.length)[0];
        ...
        this.subject.next(result.Coord__de_Vuelo__Tripulacions);
  ...
  SetWhereClause(data: any): string {
    ...
    if (data.filter.Folio != "")
      condition += " and Coord__de_Vuelo__Tripulacion.Folio = " + data.filter.Folio;
    ...
    if (data.filter.Ruta_de_Vuelo != "")
      condition += " and Coord__de_Vuelo__Tripulacion.Ruta_de_Vuelo like '%" + data.filter.Ruta_de_Vuelo + "%' ";
    if (data.filter.Fecha_y_Hora_de_Salida != "")
      condition += " and Coord__de_Vuelo__Tripulacion.Fecha_y_Hora_de_Salida like '%" + data.filter.Fecha_y_Hora_de_Salida + "%' ";
    if (data.filter.Calificacion != "")
      condition += " and Coord__de_Vuelo__Tripulacion.Calificacion = " + data.filter.Calificacion;
    if (data.filter.Observaciones != "")
      condition += " and Coord__de_Vuelo__Tripulacion.Observaciones like '%" + data.filter.Observaciones + "%' ";
  ...
  SetOrderClause(data: any): string {
    ...
    switch (data.sortField) {
      case "Folio":
        sort = " Coord__de_Vuelo__Tripulacion.Folio " + data.sortDirecction;
        break;
      ...
      case "Matricula":
        ...
        break;
      case "Ruta_de_Vuelo":
        sort = " Coord__de_Vuelo__Tripulacion.Ruta_de_Vuelo " + data.sortDirecction;
        break;
      case "Fecha_y_Hora_de_Salida":
        sort = " Coord__de_Vuelo__Tripulacion.Fecha_y_Hora_de_Salida " + data.sortDirecction;
        break;
      case "Calificacion":
        sort = " Coord__de_Vuelo__Tripulacion.Calificacion " + data.sortDirecction;
        break;
      case "Observaciones":
        sort = " Coord__de_Vuelo__Tripulacion.Observaciones " + data.sortDirecction;
        break;
  ...
  loadAdvanced(data: any) {
	...
	{
      if (typeof data.filterAdvanced.fromFolio != 'undefined' && data.filterAdvanced.fromFolio)
        condition += " AND Coord__de_Vuelo__Tripulacion.Folio >= " + data.filterAdvanced.fromFolio;

      if (typeof data.filterAdvanced.toFolio != 'undefined' && data.filterAdvanced.toFolio) 
        condition += " AND Coord__de_Vuelo__Tripulacion.Folio <= " + data.filterAdvanced.toFolio;
    }
    if ((typeof data.filterAdvanced.Numero_de_Vuelo != 'undefined' && data.filterAdvanced.Numero_de_Vuelo)) {
      ...
      condition += " AND Coord__de_Vuelo__Tripulacion.Numero_de_Vuelo In (" + Numero_de_Vuelods + ")";
    }
    if ((typeof data.filterAdvanced.Matricula != 'undefined' && data.filterAdvanced.Matricula)) {
      ...
      condition += " AND Coord__de_Vuelo__Tripulacion.Matricula In (" + Matriculads + ")";
    }
    switch (data.filterAdvanced.Ruta_de_VueloFilter) {
      case Enumerations.Enums.Filters.BeginWith:
        condition += " AND Coord__de_Vuelo__Tripulacion.Ruta_de_Vuelo LIKE '" + data.filterAdvanced.Ruta_de_Vuelo + "%'";
        break;
      case Enumerations.Enums.Filters.Contains:
        condition += " AND Coord__de_Vuelo__Tripulacion.Ruta_de_Vuelo LIKE '%" + data.filterAdvanced.Ruta_de_Vuelo + "%'";
        break;
      case Enumerations.Enums.Filters.EndWith:
        ...
        break;
      case Enumerations.Enums.Filters.Exact:
        condition += " AND Coord__de_Vuelo__Tripulacion.Ruta_de_Vuelo = '" + data.filterAdvanced.Ruta_de_Vuelo + "'";
        break;
    }
    switch (data.filterAdvanced.Fecha_y_Hora_de_SalidaFilter) {
      case Enumerations.Enums.Filters.BeginWith:
        condition += " AND Coord__de_Vuelo__Tripulacion.Fecha_y_Hora_de_Salida LIKE '" + data.filterAdvanced.Fecha_y_Hora_de_Salida + "%'";
        break;
      case Enumerations.Enums.Filters.Contains:
        condition += " AND Coord__de_Vuelo__Tripulacion.Fecha_y_Hora_de_Salida LIKE '%" + data.filterAdvanced.Fecha_y_Hora_de_Salida + "%'";
        break;
      case Enumerations.Enums.Filters.EndWith:
        ...
        break;
      case Enumerations.Enums.Filters.Exact:
        condition += " AND Coord__de_Vuelo__Tripulacion.Fecha_y_Hora_de_Salida = '" + data.filterAdvanced.Fecha_y_Hora_de_Salida + "'";
        break;
    }
	...
	{
      if (typeof data.filterAdvanced.fromCalificacion != 'undefined' && data.filterAdvanced.fromCalificacion)
        condition += " AND Coord__de_Vuelo__Tripulacion.Calificacion >= " + data.filterAdvanced.fromCalificacion;

      if (typeof data.filterAdvanced.toCalificacion != 'undefined' && data.filterAdvanced.toCalificacion) 
        condition += " AND Coord__de_Vuelo__Tripulacion.Calificacion <= " + data.filterAdvanced.toCalificacion;
    }
    switch (data.filterAdvanced.ObservacionesFilter) {
      case Enumerations.Enums.Filters.BeginWith:
        condition += " AND Coord__de_Vuelo__Tripulacion.Observaciones LIKE '" + data.filterAdvanced.Observaciones + "%'";
        break;
      case Enumerations.Enums.Filters.Contains:
        condition += " AND Coord__de_Vuelo__Tripulacion.Observaciones LIKE '%" + data.filterAdvanced.Observaciones + "%'";
        break;
      case Enumerations.Enums.Filters.EndWith:
        ...
        break;
      case Enumerations.Enums.Filters.Exact:
        condition += " AND Coord__de_Vuelo__Tripulacion.Observaciones = '" + data.filterAdvanced.Observaciones + "'";
        break;
    }

...
import { Catalogo_serviciosRoutingModule } from '../Catalogo_servicios/Catalogo_servicios-routing.module';
...
@NgModule({
  declarations: [Catalogo_serviciosComponent,
    ListCatalogo_serviciosComponent,
    ShowAdvanceFilterCatalogo_serviciosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Catalogo_serviciosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Catalogo_serviciosModule { }

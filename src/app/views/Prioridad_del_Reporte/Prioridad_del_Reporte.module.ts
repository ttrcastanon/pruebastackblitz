...
import { Prioridad_del_ReporteRoutingModule } from '../Prioridad_del_Reporte/Prioridad_del_Reporte-routing.module';
...
@NgModule({
  declarations: [Prioridad_del_ReporteComponent,
    ListPrioridad_del_ReporteComponent,
    ShowAdvanceFilterPrioridad_del_ReporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Prioridad_del_ReporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Prioridad_del_ReporteModule { }

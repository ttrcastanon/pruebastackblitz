...
import { Motivo_de_Edicion_de_CotizacionRoutingModule } from '../Motivo_de_Edicion_de_Cotizacion/Motivo_de_Edicion_de_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Motivo_de_Edicion_de_CotizacionComponent,
    ListMotivo_de_Edicion_de_CotizacionComponent,
    ShowAdvanceFilterMotivo_de_Edicion_de_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Motivo_de_Edicion_de_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Motivo_de_Edicion_de_CotizacionModule { }

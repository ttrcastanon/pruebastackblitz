...
import { Documentacion_de_PasajeroRoutingModule } from '../Documentacion_de_Pasajero/Documentacion_de_Pasajero-routing.module';
...
@NgModule({
  declarations: [Documentacion_de_PasajeroComponent,
    ListDocumentacion_de_PasajeroComponent,
    ShowAdvanceFilterDocumentacion_de_PasajeroComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Documentacion_de_PasajeroRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Documentacion_de_PasajeroModule { }

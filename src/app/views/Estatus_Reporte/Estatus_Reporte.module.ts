...
import { Estatus_ReporteRoutingModule } from '../Estatus_Reporte/Estatus_Reporte-routing.module';
...
@NgModule({
  declarations: [Estatus_ReporteComponent,
    ListEstatus_ReporteComponent,
    ShowAdvanceFilterEstatus_ReporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Estatus_ReporteModule { }

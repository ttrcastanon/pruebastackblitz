...
import { Tipo_de_Solicitud_de_ComprasRoutingModule } from '../Tipo_de_Solicitud_de_Compras/Tipo_de_Solicitud_de_Compras-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Solicitud_de_ComprasComponent,
    ListTipo_de_Solicitud_de_ComprasComponent,
    ShowAdvanceFilterTipo_de_Solicitud_de_ComprasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Solicitud_de_ComprasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Solicitud_de_ComprasModule { }

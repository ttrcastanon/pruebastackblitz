...
import { Filtros_de_reportesRoutingModule } from '../Filtros_de_reportes/Filtros_de_reportes-routing.module';
...
@NgModule({
  declarations: [Filtros_de_reportesComponent,
    ListFiltros_de_reportesComponent,
    ShowAdvanceFilterFiltros_de_reportesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Filtros_de_reportesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Filtros_de_reportesModule { }

...
import { Cierre_de_VueloRoutingModule } from '../Cierre_de_Vuelo/Cierre_de_Vuelo-routing.module';
...
@NgModule({
  declarations: [Cierre_de_VueloComponent,
    ListCierre_de_VueloComponent,
    ShowAdvanceFilterCierre_de_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Cierre_de_VueloModule { }

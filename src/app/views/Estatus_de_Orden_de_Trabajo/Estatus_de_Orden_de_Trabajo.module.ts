...
import { Estatus_de_Orden_de_TrabajoRoutingModule } from '../Estatus_de_Orden_de_Trabajo/Estatus_de_Orden_de_Trabajo-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Orden_de_TrabajoComponent,
    ListEstatus_de_Orden_de_TrabajoComponent,
    ShowAdvanceFilterEstatus_de_Orden_de_TrabajoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Orden_de_TrabajoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Orden_de_TrabajoModule { }

...
import { Tipo_Persona_NotificarRoutingModule } from '../Tipo_Persona_Notificar/Tipo_Persona_Notificar-routing.module';
...
@NgModule({
  declarations: [Tipo_Persona_NotificarComponent,
    ListTipo_Persona_NotificarComponent,
    ShowAdvanceFilterTipo_Persona_NotificarComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_Persona_NotificarRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_Persona_NotificarModule { }

...
import { Coordinacion_HandlingRoutingModule } from '../Coordinacion_Handling/Coordinacion_Handling-routing.module';
...
import { ModalCoordinacionHandlingComponent } from './modal-coordinacion-handling/modal-coordinacion-handling.component';
...
@NgModule({
  declarations: [
    Coordinacion_HandlingComponent,
    ListCoordinacion_HandlingComponent,
    ShowAdvanceFilterCoordinacion_HandlingComponent,
    ModalCoordinacionHandlingComponent
  ],
  imports: [
    SharedModule,
    CommonModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Coordinacion_HandlingRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Coordinacion_HandlingModule { }

...
@Component({
  selector: 'app-show-advance-filter-Coordinacion_Handling',
  templateUrl: './show-advance-filter-Coordinacion_Handling.component.html',
  styleUrls: ['./show-advance-filter-Coordinacion_Handling.component.scss']
})
export class ShowAdvanceFilterCoordinacion_HandlingComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Coordinacion_Handling/list']);
  }

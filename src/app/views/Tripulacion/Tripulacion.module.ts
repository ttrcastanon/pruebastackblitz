...
import { TripulacionRoutingModule } from '../Tripulacion/Tripulacion-routing.module';
...
@NgModule({
  declarations: [TripulacionComponent,
    ListTripulacionComponent,
    ShowAdvanceFilterTripulacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,

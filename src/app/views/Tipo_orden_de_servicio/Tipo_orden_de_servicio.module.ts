...
import { Tipo_orden_de_servicioRoutingModule } from '../Tipo_orden_de_servicio/Tipo_orden_de_servicio-routing.module';
...
@NgModule({
  declarations: [Tipo_orden_de_servicioComponent,
    ListTipo_orden_de_servicioComponent,
    ShowAdvanceFilterTipo_orden_de_servicioComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_orden_de_servicioRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_orden_de_servicioModule { }

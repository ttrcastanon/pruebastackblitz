...
import { Gestion_de_ExportacionRoutingModule } from '../Gestion_de_Exportacion/Gestion_de_Exportacion-routing.module';
...
@NgModule({
  declarations: [Gestion_de_ExportacionComponent,
    ListGestion_de_ExportacionComponent,
    ShowAdvanceFilterGestion_de_ExportacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Gestion_de_ExportacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Gestion_de_ExportacionModule { }

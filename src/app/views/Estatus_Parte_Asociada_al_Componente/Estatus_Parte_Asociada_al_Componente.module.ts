...
import { Estatus_Parte_Asociada_al_ComponenteRoutingModule } from '../Estatus_Parte_Asociada_al_Componente/Estatus_Parte_Asociada_al_Componente-routing.module';
...
@NgModule({
  declarations: [Estatus_Parte_Asociada_al_ComponenteComponent,
    ListEstatus_Parte_Asociada_al_ComponenteComponent,
    ShowAdvanceFilterEstatus_Parte_Asociada_al_ComponenteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_Parte_Asociada_al_ComponenteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_Parte_Asociada_al_ComponenteModule { }

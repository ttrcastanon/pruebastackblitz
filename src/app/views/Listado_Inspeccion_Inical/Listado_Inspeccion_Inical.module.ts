...
import { Listado_Inspeccion_InicalRoutingModule } from '../Listado_Inspeccion_Inical/Listado_Inspeccion_Inical-routing.module';
...
@NgModule({
  declarations: [Listado_Inspeccion_InicalComponent,
    ListListado_Inspeccion_InicalComponent,
    ShowAdvanceFilterListado_Inspeccion_InicalComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_Inspeccion_InicalRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_Inspeccion_InicalModule { }

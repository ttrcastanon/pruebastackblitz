...
import { Configuracion_de_Codigo_ComputarizadoRoutingModule } from '../Configuracion_de_Codigo_Computarizado/Configuracion_de_Codigo_Computarizado-routing.module';
...
@NgModule({
  declarations: [Configuracion_de_Codigo_ComputarizadoComponent,
    ListConfiguracion_de_Codigo_ComputarizadoComponent,
    ShowAdvanceFilterConfiguracion_de_Codigo_ComputarizadoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Configuracion_de_Codigo_ComputarizadoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Configuracion_de_Codigo_ComputarizadoModule { }

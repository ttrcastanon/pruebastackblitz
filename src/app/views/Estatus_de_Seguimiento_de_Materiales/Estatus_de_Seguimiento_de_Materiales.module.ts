...
import { Estatus_de_Seguimiento_de_MaterialesRoutingModule } from '../Estatus_de_Seguimiento_de_Materiales/Estatus_de_Seguimiento_de_Materiales-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Seguimiento_de_MaterialesComponent,
    ListEstatus_de_Seguimiento_de_MaterialesComponent,
    ShowAdvanceFilterEstatus_de_Seguimiento_de_MaterialesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Seguimiento_de_MaterialesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Seguimiento_de_MaterialesModule { }

...
import { Funcionalidades_para_NotificacionRoutingModule } from '../Funcionalidades_para_Notificacion/Funcionalidades_para_Notificacion-routing.module';
...
@NgModule({
  declarations: [Funcionalidades_para_NotificacionComponent,
    ListFuncionalidades_para_NotificacionComponent,
    ShowAdvanceFilterFuncionalidades_para_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Funcionalidades_para_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Funcionalidades_para_NotificacionModule { }

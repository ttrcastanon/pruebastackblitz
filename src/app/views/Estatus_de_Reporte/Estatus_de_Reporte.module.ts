...
import { Estatus_de_ReporteRoutingModule } from '../Estatus_de_Reporte/Estatus_de_Reporte-routing.module';
...
@NgModule({
  declarations: [Estatus_de_ReporteComponent,
    ListEstatus_de_ReporteComponent,
    ShowAdvanceFilterEstatus_de_ReporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_ReporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_ReporteModule { }

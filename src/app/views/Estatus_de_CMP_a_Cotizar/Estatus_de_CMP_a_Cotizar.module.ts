...
import { Estatus_de_CMP_a_CotizarRoutingModule } from '../Estatus_de_CMP_a_Cotizar/Estatus_de_CMP_a_Cotizar-routing.module';
...
@NgModule({
  declarations: [Estatus_de_CMP_a_CotizarComponent,
    ListEstatus_de_CMP_a_CotizarComponent,
    ShowAdvanceFilterEstatus_de_CMP_a_CotizarComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_CMP_a_CotizarRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_CMP_a_CotizarModule { }

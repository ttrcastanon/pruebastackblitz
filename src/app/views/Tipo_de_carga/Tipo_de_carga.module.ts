...
import { Tipo_de_cargaRoutingModule } from '../Tipo_de_carga/Tipo_de_carga-routing.module';
...
@NgModule({
  declarations: [Tipo_de_cargaComponent,
    ListTipo_de_cargaComponent,
    ShowAdvanceFilterTipo_de_cargaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_cargaModule { }

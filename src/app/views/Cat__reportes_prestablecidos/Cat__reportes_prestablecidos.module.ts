...
import { Cat__reportes_prestablecidosRoutingModule } from '../Cat__reportes_prestablecidos/Cat__reportes_prestablecidos-routing.module';
...
@NgModule({
  declarations: [Cat__reportes_prestablecidosComponent,
    ListCat__reportes_prestablecidosComponent,
    ShowAdvanceFilterCat__reportes_prestablecidosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Cat__reportes_prestablecidosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Cat__reportes_prestablecidosModule { }

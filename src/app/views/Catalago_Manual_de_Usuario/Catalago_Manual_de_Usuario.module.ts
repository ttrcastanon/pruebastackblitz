...
import { Catalago_Manual_de_UsuarioRoutingModule } from '../Catalago_Manual_de_Usuario/Catalago_Manual_de_Usuario-routing.module';
...
@NgModule({
  declarations: [Catalago_Manual_de_UsuarioComponent,
    ListCatalago_Manual_de_UsuarioComponent,
    ShowAdvanceFilterCatalago_Manual_de_UsuarioComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Catalago_Manual_de_UsuarioRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Catalago_Manual_de_UsuarioModule { }

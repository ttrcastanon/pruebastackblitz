...
@Component({
  selector: 'app-modal-coord-de-vuelo-documentacion',
  templateUrl: './modal-coord-de-vuelo-documentacion.component.html',
  styleUrls: ['./modal-coord-de-vuelo-documentacion.component.scss'],
  animations: [
...
export class ModalCoordDeVueloDocumentacionComponent implements OnInit {
  ...
  valorActualDoc: number
  valorActualPax: number
  isDocOpen: boolean =  false
  isPaxOpen: boolean = false
  ...
  constructor(private fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<ModalCoordDeVueloDocumentacionComponent>,
  ...
  ngOnInit(): void {
    ...
    this._seguridad.permisos(AppConstants.Permisos.Coord__de_Vuelo__Documentacion).subscribe((response) => {
  ...
  cancelEditAeronave_Documentacion(element: any) {
    let index = this.dataSourceAeronave_Documentacion.data.indexOf(element);
    const formAeronave_Documentacion = this.Aeronave_DocumentacionItems.controls[index] as FormGroup;    
    formAeronave_Documentacion.get('Confirmado').setValue(this.valorActualDoc);
    element.edit = false;
    if (element.isNew) {
      this.Aeronave_DocumentacionData[index].IsDeleted = true;
      this.dataSourceAeronave_Documentacion.data = this.Aeronave_DocumentacionData;
  ...
  editAeronave_Documentacion(element: any) {
    ...
    this.valorActualDoc = formAeronave_Documentacion.get('Confirmado').value;
    this.isDocOpen = true
  ...
  //#region PAXs Documentacion Items
  ...
  cancelEditPAXS_Documentacion(element: any) {
    let index = this.dataSourcePAXS_Documentacion.data.indexOf(element);
    const formPAXS_Documentacion = this.PAXS_DocumentacionItems.controls[index] as FormGroup;
    formPAXS_Documentacion.get('Confirmado').setValue(this.valorActualPax);
    element.edit = false;
    if (element.isNew) {
      this.PAXS_DocumentacionData[index].IsDeleted = true;
      this.dataSourcePAXS_Documentacion.data = this.PAXS_DocumentacionData;
  ...
  editPAXS_Documentacion(element: any) {
    ...
    const formPAXS_Documentacion = this.PAXS_DocumentacionItems.controls[index] as FormGroup;
    formPAXS_Documentacion.get('Descripcion').disable()
    this. valorActualPax = formPAXS_Documentacion.get('Confirmado').value
    element.edit = true;
  }
  ...
  populateControls() {
    ...
    this.Coord__de_Vuelo__DocumentacionForm.get('Numero_de_Vuelo').valueChanges.pipe(
      ...
      if (this.VueloSeleccion != null && this.VueloSeleccion != "") {
        if (result.Solicitud_de_Vuelos.length >= 1) {
  ...
  async saveData(): Promise<any> {
    ...
    if (this.rulesBeforeSave()) {
      ...
      if (this.model.Folio > 0) {
        await this.Coord__de_Vuelo__DocumentacionService.update(this.model.Folio, entity).toPromise().then(async id => {
  ...
  rulesOnInit() {
    ...
    //   this.brf.HideFieldOfForm(this.Coord__de_Vuelo__DocumentacionForm, "Numero_de_Vuelo");
    //   this.brf.SetNotRequiredControl(this.Coord__de_Vuelo__DocumentacionForm, "Numero_de_Vuelo");
    // }
    //TERMINA - BRID:1900
    ...
    if (this.operation == 'New' || this.operation == 'Update') {
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Numero_de_Vuelo', 0);
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Matricula', 0);
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Ruta_de_Vuelo', 0);
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Fecha_y_Hora_de_Salida', 0);
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Calificacion', 0);
      //this.brf.HideFieldOfForm(this.Coord__de_Vuelo__DocumentacionForm, "Numero_de_Vuelo");
      this.brf.SetNotRequiredControl(this.Coord__de_Vuelo__DocumentacionForm, "Observaciones");
    }
    //TERMINA - BRID:2059

    //INICIA - BRID:2617 - Ocultar folioo - Autor: Lizeth Villa - Actualización: 4/7/2021 10:07:54 AM
    this.brf.HideFieldOfForm(this.Coord__de_Vuelo__DocumentacionForm, "Folio");
    this.brf.SetNotRequiredControl(this.Coord__de_Vuelo__DocumentacionForm, "Folio");
    //TERMINA - BRID:2617
    ...
    if (this.brf.EvaluaQuery("SELECT COUNT(*) from Solicitud_de_Vuelo where folio = " + this.localStorageHelper.getItemFromLocalStorage('SpartanOperationId') + " and estatus = 9	", 1, 'ABC123') == this.brf.TryParseInt('1', '1') && this.brf.EvaluaQuery("if ( " + this.localStorageHelper.getLoggedUserInfo().RoleId + "= 1 or " + this.localStorageHelper.getLoggedUserInfo().RoleId + "= 9 ) begin select 1 end	", 1, 'ABC123') != this.brf.TryParseInt('1', '1')) {
      this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Folio', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Numero_de_Vuelo', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Matricula', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Ruta_de_Vuelo', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Fecha_y_Hora_de_Salida', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Calificacion', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Observaciones', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Folio', 0); this.brf.SetEnabledControl(this.Coord__de_Vuelo__DocumentacionForm, 'Coordinacion_Documentacion', 0);
  ...
  rulesBeforeSave(): boolean {
    ...
    // if(this.isDocOpen) {
    //   alert("Has dejado un renglón sin guardar en Documentación");
    //   result = false;
    // }

...
@Component({
  selector: 'app-show-advance-filter-Coord__de_Vuelo__Documentacion',
  templateUrl: './show-advance-filter-Coord__de_Vuelo__Documentacion.component.html',
  styleUrls: ['./show-advance-filter-Coord__de_Vuelo__Documentacion.component.scss']
})
export class ShowAdvanceFilterCoord__de_Vuelo__DocumentacionComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Coord__de_Vuelo__Documentacion/list']);
  }

...
import { Estatus_de_Revision_en_CotizacionRoutingModule } from '../Estatus_de_Revision_en_Cotizacion/Estatus_de_Revision_en_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Revision_en_CotizacionComponent,
    ListEstatus_de_Revision_en_CotizacionComponent,
    ShowAdvanceFilterEstatus_de_Revision_en_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Revision_en_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Revision_en_CotizacionModule { }

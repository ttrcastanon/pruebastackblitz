...
import { Solicitud_de_VueloRoutingModule } from '../Solicitud_de_Vuelo/Solicitud_de_Vuelo-routing.module';
...
@NgModule({
  declarations: [Solicitud_de_VueloComponent,
    ListSolicitud_de_VueloComponent,
    ShowAdvanceFilterSolicitud_de_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Solicitud_de_VueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
    MdbTabsModule
  ],
...
export class Solicitud_de_VueloModule { }

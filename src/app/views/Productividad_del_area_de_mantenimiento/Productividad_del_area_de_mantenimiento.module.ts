...
import { Productividad_del_area_de_mantenimientoRoutingModule } from '../Productividad_del_area_de_mantenimiento/Productividad_del_area_de_mantenimiento-routing.module';
...
@NgModule({
  declarations: [Productividad_del_area_de_mantenimientoComponent,
    ListProductividad_del_area_de_mantenimientoComponent,
    ShowAdvanceFilterProductividad_del_area_de_mantenimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Productividad_del_area_de_mantenimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Productividad_del_area_de_mantenimientoModule { }

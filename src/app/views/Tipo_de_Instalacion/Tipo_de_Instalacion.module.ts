...
import { Tipo_de_InstalacionRoutingModule } from '../Tipo_de_Instalacion/Tipo_de_Instalacion-routing.module';
...
@NgModule({
  declarations: [Tipo_de_InstalacionComponent,
    ListTipo_de_InstalacionComponent,
    ShowAdvanceFilterTipo_de_InstalacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_InstalacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_InstalacionModule { }

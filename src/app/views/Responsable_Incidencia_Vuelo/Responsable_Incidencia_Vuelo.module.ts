...
import { Responsable_Incidencia_VueloRoutingModule } from '../Responsable_Incidencia_Vuelo/Responsable_Incidencia_Vuelo-routing.module';
...
@NgModule({
  declarations: [Responsable_Incidencia_VueloComponent,
    ListResponsable_Incidencia_VueloComponent,
    ShowAdvanceFilterResponsable_Incidencia_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Responsable_Incidencia_VueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Responsable_Incidencia_VueloModule { }

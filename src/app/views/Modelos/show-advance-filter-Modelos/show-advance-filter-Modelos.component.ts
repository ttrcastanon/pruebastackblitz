...
@Component({
  selector: 'app-show-advance-filter-Modelos',
  templateUrl: './show-advance-filter-Modelos.component.html',
  styleUrls: ['./show-advance-filter-Modelos.component.scss']
})
export class ShowAdvanceFilterModelosComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Modelos/list']);
  }

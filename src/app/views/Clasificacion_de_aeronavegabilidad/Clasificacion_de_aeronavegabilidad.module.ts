...
import { Clasificacion_de_aeronavegabilidadRoutingModule } from '../Clasificacion_de_aeronavegabilidad/Clasificacion_de_aeronavegabilidad-routing.module';
...
@NgModule({
  declarations: [Clasificacion_de_aeronavegabilidadComponent,
    ListClasificacion_de_aeronavegabilidadComponent,
    ShowAdvanceFilterClasificacion_de_aeronavegabilidadComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Clasificacion_de_aeronavegabilidadRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Clasificacion_de_aeronavegabilidadModule { }

...
import { Tipo_de_TransporteRoutingModule } from '../Tipo_de_Transporte/Tipo_de_Transporte-routing.module';
...
@NgModule({
  declarations: [Tipo_de_TransporteComponent,
    ListTipo_de_TransporteComponent,
    ShowAdvanceFilterTipo_de_TransporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_TransporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_TransporteModule { }

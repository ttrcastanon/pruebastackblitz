...
import { Layout_Cuentas_por_pagarRoutingModule } from '../Layout_Cuentas_por_pagar/Layout_Cuentas_por_pagar-routing.module';
...
@NgModule({
  declarations: [Layout_Cuentas_por_pagarComponent,
    ListLayout_Cuentas_por_pagarComponent,
    ShowAdvanceFilterLayout_Cuentas_por_pagarComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Layout_Cuentas_por_pagarRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Layout_Cuentas_por_pagarModule { }

...
@Component({
  selector: 'app-show-advance-filter-Concepto',
  templateUrl: './show-advance-filter-Concepto.component.html',
  styleUrls: ['./show-advance-filter-Concepto.component.scss']
})
export class ShowAdvanceFilterConceptoComponent implements OnInit, AfterViewInit {

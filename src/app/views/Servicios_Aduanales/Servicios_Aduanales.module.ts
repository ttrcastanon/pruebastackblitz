...
import { Servicios_AduanalesRoutingModule } from '../Servicios_Aduanales/Servicios_Aduanales-routing.module';
...
@NgModule({
  declarations: [Servicios_AduanalesComponent,
    ListServicios_AduanalesComponent,
    ShowAdvanceFilterServicios_AduanalesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Servicios_AduanalesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Servicios_AduanalesModule { }

...
import { Boletines_Directivas_aeronavegatibilidadRoutingModule } from '../Boletines_Directivas_aeronavegatibilidad/Boletines_Directivas_aeronavegatibilidad-routing.module';
...
@NgModule({
  declarations: [Boletines_Directivas_aeronavegatibilidadComponent,
    ListBoletines_Directivas_aeronavegatibilidadComponent,
    ShowAdvanceFilterBoletines_Directivas_aeronavegatibilidadComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Boletines_Directivas_aeronavegatibilidadRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Boletines_Directivas_aeronavegatibilidadModule { }

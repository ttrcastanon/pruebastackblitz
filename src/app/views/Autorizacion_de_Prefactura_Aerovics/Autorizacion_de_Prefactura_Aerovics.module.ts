...
import { Autorizacion_de_Prefactura_AerovicsRoutingModule } from '../Autorizacion_de_Prefactura_Aerovics/Autorizacion_de_Prefactura_Aerovics-routing.module';
...
@NgModule({
  declarations: [Autorizacion_de_Prefactura_AerovicsComponent,
    ListAutorizacion_de_Prefactura_AerovicsComponent,
    ShowAdvanceFilterAutorizacion_de_Prefactura_AerovicsComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Autorizacion_de_Prefactura_AerovicsRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Autorizacion_de_Prefactura_AerovicsModule { }

...
import { Tipo_de_Ingreso_de_GastoRoutingModule } from '../Tipo_de_Ingreso_de_Gasto/Tipo_de_Ingreso_de_Gasto-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Ingreso_de_GastoComponent,
    ListTipo_de_Ingreso_de_GastoComponent,
    ShowAdvanceFilterTipo_de_Ingreso_de_GastoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Ingreso_de_GastoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Ingreso_de_GastoModule { }

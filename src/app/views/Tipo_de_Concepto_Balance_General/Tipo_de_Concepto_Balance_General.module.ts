...
import { Tipo_de_Concepto_Balance_GeneralRoutingModule } from '../Tipo_de_Concepto_Balance_General/Tipo_de_Concepto_Balance_General-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Concepto_Balance_GeneralComponent,
    ListTipo_de_Concepto_Balance_GeneralComponent,
    ShowAdvanceFilterTipo_de_Concepto_Balance_GeneralComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Concepto_Balance_GeneralRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Concepto_Balance_GeneralModule { }

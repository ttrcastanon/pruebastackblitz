...
import { Horarios_de_TrabajoRoutingModule } from '../Horarios_de_Trabajo/Horarios_de_Trabajo-routing.module';
...
@NgModule({
  declarations: [Horarios_de_TrabajoComponent,
    ListHorarios_de_TrabajoComponent,
    ShowAdvanceFilterHorarios_de_TrabajoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Horarios_de_TrabajoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Horarios_de_TrabajoModule { }

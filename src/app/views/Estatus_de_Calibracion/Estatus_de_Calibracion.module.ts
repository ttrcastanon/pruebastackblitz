...
import { Estatus_de_CalibracionRoutingModule } from '../Estatus_de_Calibracion/Estatus_de_Calibracion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_CalibracionComponent,
    ListEstatus_de_CalibracionComponent,
    ShowAdvanceFilterEstatus_de_CalibracionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_CalibracionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_CalibracionModule { }

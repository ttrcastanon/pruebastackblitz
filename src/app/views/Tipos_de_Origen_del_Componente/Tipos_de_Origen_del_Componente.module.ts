...
import { Tipos_de_Origen_del_ComponenteRoutingModule } from '../Tipos_de_Origen_del_Componente/Tipos_de_Origen_del_Componente-routing.module';
...
@NgModule({
  declarations: [Tipos_de_Origen_del_ComponenteComponent,
    ListTipos_de_Origen_del_ComponenteComponent,
    ShowAdvanceFilterTipos_de_Origen_del_ComponenteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipos_de_Origen_del_ComponenteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipos_de_Origen_del_ComponenteModule { }

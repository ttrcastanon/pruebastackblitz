...
import { Tipo_de_NotificacionRoutingModule } from '../Tipo_de_Notificacion/Tipo_de_Notificacion-routing.module';
...
@NgModule({
  declarations: [Tipo_de_NotificacionComponent,
    ListTipo_de_NotificacionComponent,
    ShowAdvanceFilterTipo_de_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_NotificacionModule { }

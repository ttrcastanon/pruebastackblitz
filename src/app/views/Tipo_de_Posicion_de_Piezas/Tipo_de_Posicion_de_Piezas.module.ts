...
import { Tipo_de_Posicion_de_PiezasRoutingModule } from '../Tipo_de_Posicion_de_Piezas/Tipo_de_Posicion_de_Piezas-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Posicion_de_PiezasComponent,
    ListTipo_de_Posicion_de_PiezasComponent,
    ShowAdvanceFilterTipo_de_Posicion_de_PiezasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Posicion_de_PiezasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Posicion_de_PiezasModule { }

...
import { Formato_de_salida_de_aeronaveRoutingModule } from '../Formato_de_salida_de_aeronave/Formato_de_salida_de_aeronave-routing.module';
...
@NgModule({
  declarations: [Formato_de_salida_de_aeronaveComponent,
    ListFormato_de_salida_de_aeronaveComponent,
    ShowAdvanceFilterFormato_de_salida_de_aeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Formato_de_salida_de_aeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Formato_de_salida_de_aeronaveModule { }

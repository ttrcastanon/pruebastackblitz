...
import { Documentos_RequeridosRoutingModule } from '../Documentos_Requeridos/Documentos_Requeridos-routing.module';
...
@NgModule({
  declarations: [Documentos_RequeridosComponent,
    ListDocumentos_RequeridosComponent,
    ShowAdvanceFilterDocumentos_RequeridosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Documentos_RequeridosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Documentos_RequeridosModule { }

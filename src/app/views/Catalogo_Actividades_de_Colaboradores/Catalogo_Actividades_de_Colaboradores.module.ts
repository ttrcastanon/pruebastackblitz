...
import { Catalogo_Actividades_de_ColaboradoresRoutingModule } from '../Catalogo_Actividades_de_Colaboradores/Catalogo_Actividades_de_Colaboradores-routing.module';
...
@NgModule({
  declarations: [Catalogo_Actividades_de_ColaboradoresComponent,
    ListCatalogo_Actividades_de_ColaboradoresComponent,
    ShowAdvanceFilterCatalogo_Actividades_de_ColaboradoresComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Catalogo_Actividades_de_ColaboradoresRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Catalogo_Actividades_de_ColaboradoresModule { }

...
import { Tipo_de_HospedajeRoutingModule } from '../Tipo_de_Hospedaje/Tipo_de_Hospedaje-routing.module';
...
@NgModule({
  declarations: [Tipo_de_HospedajeComponent,
    ListTipo_de_HospedajeComponent,
    ShowAdvanceFilterTipo_de_HospedajeComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_HospedajeRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_HospedajeModule { }

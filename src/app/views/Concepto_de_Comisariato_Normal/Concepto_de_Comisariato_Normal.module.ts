...
import { Concepto_de_Comisariato_NormalRoutingModule } from '../Concepto_de_Comisariato_Normal/Concepto_de_Comisariato_Normal-routing.module';
...
@NgModule({
  declarations: [Concepto_de_Comisariato_NormalComponent,
    ListConcepto_de_Comisariato_NormalComponent,
    ShowAdvanceFilterConcepto_de_Comisariato_NormalComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Concepto_de_Comisariato_NormalRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Concepto_de_Comisariato_NormalModule { }

...
import { Crear_ReporteRoutingModule } from '../Crear_Reporte/Crear_Reporte-routing.module';
...
@NgModule({
  declarations: [Crear_ReporteComponent,
    ListCrear_ReporteComponent,
    ShowAdvanceFilterCrear_ReporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Crear_ReporteModule { }

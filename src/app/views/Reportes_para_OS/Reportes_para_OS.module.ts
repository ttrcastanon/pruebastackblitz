...
import { Reportes_para_OSRoutingModule } from '../Reportes_para_OS/Reportes_para_OS-routing.module';
...
@NgModule({
  declarations: [Reportes_para_OSComponent,
    ListReportes_para_OSComponent,
    ShowAdvanceFilterReportes_para_OSComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Reportes_para_OSModule { }

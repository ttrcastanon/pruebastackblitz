...
import { Clasificacion_de_proveedoresRoutingModule } from '../Clasificacion_de_proveedores/Clasificacion_de_proveedores-routing.module';
...
@NgModule({
  declarations: [Clasificacion_de_proveedoresComponent,
    ListClasificacion_de_proveedoresComponent,
    ShowAdvanceFilterClasificacion_de_proveedoresComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Clasificacion_de_proveedoresRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Clasificacion_de_proveedoresModule { }

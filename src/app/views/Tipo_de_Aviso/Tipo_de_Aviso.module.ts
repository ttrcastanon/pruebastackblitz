...
import { Tipo_de_AvisoRoutingModule } from '../Tipo_de_Aviso/Tipo_de_Aviso-routing.module';
...
@NgModule({
  declarations: [Tipo_de_AvisoComponent,
    ListTipo_de_AvisoComponent,
    ShowAdvanceFilterTipo_de_AvisoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_AvisoModule { }

...
import { Estatus_de_ConfirmacionRoutingModule } from '../Estatus_de_Confirmacion/Estatus_de_Confirmacion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_ConfirmacionComponent,
    ListEstatus_de_ConfirmacionComponent,
    ShowAdvanceFilterEstatus_de_ConfirmacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_ConfirmacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_ConfirmacionModule { }

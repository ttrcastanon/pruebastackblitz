...
import { Cliente_FacturacionRoutingModule } from '../Cliente_Facturacion/Cliente_Facturacion-routing.module';
...
@NgModule({
  declarations: [Cliente_FacturacionComponent,
    ListCliente_FacturacionComponent,
    ShowAdvanceFilterCliente_FacturacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Cliente_FacturacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Cliente_FacturacionModule { }

...
import { Estatus_AeronaveRoutingModule } from '../Estatus_Aeronave/Estatus_Aeronave-routing.module';
...
@NgModule({
  declarations: [Estatus_AeronaveComponent,
    ListEstatus_AeronaveComponent,
    ShowAdvanceFilterEstatus_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Estatus_AeronaveModule { }

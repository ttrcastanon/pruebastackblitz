...
import { Condicion_del_itemRoutingModule } from '../Condicion_del_item/Condicion_del_item-routing.module';
...
@NgModule({
  declarations: [Condicion_del_itemComponent,
    ListCondicion_del_itemComponent,
    ShowAdvanceFilterCondicion_del_itemComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Condicion_del_itemRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Condicion_del_itemModule { }

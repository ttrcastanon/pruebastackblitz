...
import { Estatus_de_Solicitud_de_ComprasRoutingModule } from '../Estatus_de_Solicitud_de_Compras/Estatus_de_Solicitud_de_Compras-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Solicitud_de_ComprasComponent,
    ListEstatus_de_Solicitud_de_ComprasComponent,
    ShowAdvanceFilterEstatus_de_Solicitud_de_ComprasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Solicitud_de_ComprasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Solicitud_de_ComprasModule { }

...
import { Historial_de_CambiosRoutingModule } from '../Historial_de_Cambios/Historial_de_Cambios-routing.module';
...
@NgModule({
  declarations: [Historial_de_CambiosComponent,
    ListHistorial_de_CambiosComponent,
    ShowAdvanceFilterHistorial_de_CambiosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Historial_de_CambiosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Historial_de_CambiosModule { }

...
import { Tipo_de_AeropuertoRoutingModule } from '../Tipo_de_Aeropuerto/Tipo_de_Aeropuerto-routing.module';
...
@NgModule({
  declarations: [Tipo_de_AeropuertoComponent,
    ListTipo_de_AeropuertoComponent,
    ShowAdvanceFilterTipo_de_AeropuertoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_AeropuertoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_AeropuertoModule { }

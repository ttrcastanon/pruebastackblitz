...
import { Categorias_y_Documentos_RequeridosRoutingModule } from '../Categorias_y_Documentos_Requeridos/Categorias_y_Documentos_Requeridos-routing.module';
...
@NgModule({
  declarations: [Categorias_y_Documentos_RequeridosComponent,
    ListCategorias_y_Documentos_RequeridosComponent,
    ShowAdvanceFilterCategorias_y_Documentos_RequeridosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Categorias_y_Documentos_RequeridosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Categorias_y_Documentos_RequeridosModule { }

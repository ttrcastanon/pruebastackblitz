...
import { Causa_de_remocionRoutingModule } from '../Causa_de_remocion/Causa_de_remocion-routing.module';
...
@NgModule({
  declarations: [Causa_de_remocionComponent,
    ListCausa_de_remocionComponent,
    ShowAdvanceFilterCausa_de_remocionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Causa_de_remocionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Causa_de_remocionModule { }

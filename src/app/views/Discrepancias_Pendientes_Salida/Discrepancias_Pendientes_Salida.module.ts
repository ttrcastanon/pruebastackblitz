...
import { Discrepancias_Pendientes_SalidaRoutingModule } from '../Discrepancias_Pendientes_Salida/Discrepancias_Pendientes_Salida-routing.module';
...
@NgModule({
  declarations: [Discrepancias_Pendientes_SalidaComponent,
    ListDiscrepancias_Pendientes_SalidaComponent,
    ShowAdvanceFilterDiscrepancias_Pendientes_SalidaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Discrepancias_Pendientes_SalidaRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Discrepancias_Pendientes_SalidaModule { }

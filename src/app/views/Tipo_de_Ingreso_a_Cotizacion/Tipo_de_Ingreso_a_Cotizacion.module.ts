...
import { Tipo_de_Ingreso_a_CotizacionRoutingModule } from '../Tipo_de_Ingreso_a_Cotizacion/Tipo_de_Ingreso_a_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Ingreso_a_CotizacionComponent,
    ListTipo_de_Ingreso_a_CotizacionComponent,
    ShowAdvanceFilterTipo_de_Ingreso_a_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Ingreso_a_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Ingreso_a_CotizacionModule { }

...
import { Tipo_de_Condicion_AeronaveRoutingModule } from '../Tipo_de_Condicion_Aeronave/Tipo_de_Condicion_Aeronave-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Condicion_AeronaveComponent,
    ListTipo_de_Condicion_AeronaveComponent,
    ShowAdvanceFilterTipo_de_Condicion_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Condicion_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Condicion_AeronaveModule { }

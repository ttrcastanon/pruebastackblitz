...
@Component({
  selector: 'app-Detalle_de_Actividades_de_Colaboradores',
  templateUrl: './Detalle_de_Actividades_de_Colaboradores.component.html',
  styleUrls: ['./Detalle_de_Actividades_de_Colaboradores.component.scss'],
  animations: [
...
export class Detalle_de_Actividades_de_ColaboradoresComponent implements OnInit, AfterViewInit {
	...
	Detalle_de_Actividades_de_ColaboradoresForm: FormGroup;
	public Editor = ClassicEditor;
	model: Detalle_de_Actividades_de_Colaboradores;
	arrayBuffer: string | ArrayBuffer;
	cthis = this;
	public varActividades_de_los_Colaboradores: Actividades_de_los_Colaboradores[] = [];
	public varCreacion_de_Usuarios: Creacion_de_Usuarios[] = [];
	public varCargos: Cargos[] = [];
	public varCliente: Cliente[] = [];
	optionsNo_OT: Observable<Orden_de_Trabajo[]>;
	hasOptionsNo_OT: boolean;
	isLoadingNo_OT: boolean;
	optionsNo_OS: Observable<Orden_de_servicio[]>;
	hasOptionsNo_OS: boolean;
	isLoadingNo_OS: boolean;
	optionsNo_Vuelo: Observable<Solicitud_de_Vuelo[]>;
	hasOptionsNo_Vuelo: boolean;
	isLoadingNo_Vuelo: boolean;
	optionsNo_Reporte: Observable<Crear_Reporte[]>;
	hasOptionsNo_Reporte: boolean;
	isLoadingNo_Reporte: boolean;
  ...
  NoOTSeleccionado: any = null;
  NoOSSeleccionado: any = null;
  VueloSeleccionado: any = null;
  NoReporteSeleccionado: any = null;
  MatriculaSeleccionado: any = null;
  ...
  constructor(private fb: FormBuilder,
    ...
    private Detalle_de_Actividades_de_ColaboradoresService: Detalle_de_Actividades_de_ColaboradoresService,
    ...
    this.model = new Detalle_de_Actividades_de_Colaboradores(this.fb);
    this.Detalle_de_Actividades_de_ColaboradoresForm = this.model.buildFormGroup();
	
	this.Detalle_de_Actividades_de_ColaboradoresForm.get('Folio').disable();
    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Folio').setValue('Auto');
  ...
  async getActividadesColaboradores() {
    ...
    let fechaReporte = this.Detalle_de_Actividades_de_ColaboradoresForm.get('Fecha_de_Reporte').value;
    let colaborador = this.Detalle_de_Actividades_de_ColaboradoresForm.get('Colaborador').value.Clave;
  ...
  async saveTaskToBD(Inicio, Fin, Observaciones, Concepto, FolioDetalle) {
    ...
    let folio = this.Detalle_de_Actividades_de_ColaboradoresForm.get('Folio').value == "Auto" ? 0 : this.Detalle_de_Actividades_de_ColaboradoresForm.get('Folio').value;
    ...
    if(FolioDetalle == null) {
      ...
      this.Detalle_de_Actividades_de_ColaboradoresForm.get('Folio').setValue(resultFolio);
  ...
  async cargaPuestoEmpresa() {
    ...
    this.brf.SetValueControl(this.Detalle_de_Actividades_de_ColaboradoresForm,"Puesto", puesto);        
    this.brf.SetValueControl(this.Detalle_de_Actividades_de_ColaboradoresForm,"Empresa", empresa);
  }
    ...
    this.route
      ...
      .subscribe(v => {
        if (v.readOnly) {
          ...
          this.Detalle_de_Actividades_de_ColaboradoresForm.disable();
  ...
  async populateModel(id: number) {
    ...
    let result =  await this.Detalle_de_Actividades_de_ColaboradoresService.listaSelAll(0, 1, 'Detalle_de_Actividades_de_Colaboradores.Folio=' + id).toPromise();
    if (result.Detalle_de_Actividades_de_Colaboradoress.length > 0) {
      
        this.model.fromObject(result.Detalle_de_Actividades_de_Colaboradoress[0]);
        
        this.Detalle_de_Actividades_de_ColaboradoresForm.get('Colaborador').setValue(
          result.Detalle_de_Actividades_de_Colaboradoress[0].Colaborador_Creacion_de_Usuarios.Nombre_completo,
          { onlySelf: false, emitEvent: true }
        );
        this.Detalle_de_Actividades_de_ColaboradoresForm.get('Puesto').setValue(
          result.Detalle_de_Actividades_de_Colaboradoress[0].Puesto_Cargos.Descripcion,
          { onlySelf: false, emitEvent: true }
        );
        this.Detalle_de_Actividades_de_ColaboradoresForm.get('Empresa').setValue(
          result.Detalle_de_Actividades_de_Colaboradoress[0].Empresa_Cliente.Razon_Social,
          { onlySelf: false, emitEvent: true }
        );
        ...
        this.Detalle_de_Actividades_de_ColaboradoresForm.markAllAsTouched();
        this.Detalle_de_Actividades_de_ColaboradoresForm.updateValueAndValidity();
  ...
  getParamsFromUrl() {
    this.route.paramMap.subscribe(
      params => {
        ...
        if (this.model.Folio) {
          this.operation = !this.Detalle_de_Actividades_de_ColaboradoresForm.disabled ? "Update" : this.operation;
  ...
  populateControls() {
    ...
    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Colaborador').valueChanges.pipe(
      startWith(''),
      debounceTime(1),
      ...
      if(this.ColaboradorSeleccionado != null && this.ColaboradorSeleccionado != "") {
        if(result?.Creacion_de_Usuarioss?.length == 1){
          this.Detalle_de_Actividades_de_ColaboradoresForm.get('Colaborador').setValue(result?.Creacion_de_Usuarioss[0], { onlySelf: true, emitEvent: false });
        }
      }
    ...
    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Puesto').valueChanges.pipe(
      startWith(''),
      debounceTime(1),
      ...
      this.hasOptionsPuesto = result?.Cargoss?.length > 0;
	    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Puesto').setValue(result?.Cargoss[0], { onlySelf: true, emitEvent: false });
    ...
    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Empresa').valueChanges.pipe(
      startWith(''),
      debounceTime(1),
      ...
      this.hasOptionsEmpresa = result?.Clientes?.length > 0;
	    this.Detalle_de_Actividades_de_ColaboradoresForm.get('Empresa').setValue(result?.Clientes[0], { onlySelf: true, emitEvent: false });
  ...
  filterCb(combo: string, filter: string) {
    switch (combo) {
      ...
      case 'Colaborador': {
        this.Creacion_de_UsuariosService.listaSelAll(1, 1000, filter).subscribe(x => {
          this.varCreacion_de_Usuarios = x.Creacion_de_Usuarioss;
        });
        break;
      }
      case 'Puesto': {
  ...
  async saveData(): Promise<any> {
    ...
    if (this.rulesBeforeSave()) {
      const entity = this.Detalle_de_Actividades_de_ColaboradoresForm.value;
      entity.Folio = this.model.Folio;
      entity.No_OT = this.Detalle_de_Actividades_de_ColaboradoresForm.get('No_OT').value.Folio;
      entity.No_OS = this.Detalle_de_Actividades_de_ColaboradoresForm.get('No_OS').value.Folio;
      entity.No_Vuelo = this.Detalle_de_Actividades_de_ColaboradoresForm.get('No_Vuelo').value.Folio;
      entity.No_Reporte = this.Detalle_de_Actividades_de_ColaboradoresForm.get('No_Reporte').value.Folio;
      entity.Matricula = this.Detalle_de_Actividades_de_ColaboradoresForm.get('Matricula').value.Matricula;
      entity.Concepto = this.Detalle_de_Actividades_de_ColaboradoresForm.get('Concepto').value.Clave;
	  	  
	  
	  if (this.model.Folio > 0 ) {
        await this.Detalle_de_Actividades_de_ColaboradoresService.update(this.model.Folio, entity).toPromise();
        ...
        await (this.Detalle_de_Actividades_de_ColaboradoresService.insert(entity).toPromise().then(async id => {
  ...
  async saveAndNew() {
    await this.saveData();
    if (this.model.Folio === 0 ) {
      this.Detalle_de_Actividades_de_ColaboradoresForm.reset();
      this.model = new Detalle_de_Actividades_de_Colaboradores(this.fb);
      this.Detalle_de_Actividades_de_ColaboradoresForm = this.model.buildFormGroup();

    } else {
      this.router.navigate(['views/Detalle_de_Actividades_de_Colaboradores/add']);
    }
  }
  ...
  //Inicio de Reglas
    ...
    async Colaborador_ExecuteBusinessRules(): Promise<void> {
      ...
      this.brf.SetValueControl(this.Detalle_de_Actividades_de_ColaboradoresForm,"Folio", this.dataSourceActividadesColaboradores.data[0].Folio);        
      this.brf.SetValueControl(this.Detalle_de_Actividades_de_ColaboradoresForm,"Inicio_Horario_Laboral", this.dataSourceActividadesColaboradores.data[0].Inicio_Horario_Laboral);
      this.brf.SetValueControl(this.Detalle_de_Actividades_de_ColaboradoresForm,"Fin_Horario_Laboral", this.dataSourceActividadesColaboradores.data[0].Fin_Horario_Laboral);

      this.horasRegistradas = this.dataSourceActividadesColaboradores.data[0].Horas_Registradas;
      this.horasFaltantes = this.dataSourceActividadesColaboradores.data[0].Horas_Faltantes;
      this.horasExtras = this.dataSourceActividadesColaboradores.data[0].Horas_Extras;
      ...
      this.dataSourceDetalleActividadesColaborador.data.forEach( async x => {
        this.taskList.push({ 
          ...
          Orden_Trabajo: x.No_OT,
          Orden_Servicio: x.No_OS,
          Reporte: x.No_Reporte,
          Matricula: x.Matricula,    
          Hora_Normal: x.Hora_Normal,      
          Hora_Extra: x.Horas_Extra          
        })
      });
    ...
    Hora_Inicial_ExecuteBusinessRules(): void {
        //Hora_Inicial_FieldExecuteBusinessRulesEnd
    }
    Hora_Final_ExecuteBusinessRules(): void {
        //Hora_Final_FieldExecuteBusinessRulesEnd
    }
   
    Concepto_ExecuteBusinessRules(): void {
        //Concepto_FieldExecuteBusinessRulesEnd
    }
    Hora_Normal_ExecuteBusinessRules(): void {
        //Hora_Normal_FieldExecuteBusinessRulesEnd
    }
    Horas_Extra_ExecuteBusinessRules(): void {
        //Horas_Extra_FieldExecuteBusinessRulesEnd
    }
    Tiempo_Normal_ExecuteBusinessRules(): void {
        //Tiempo_Normal_FieldExecuteBusinessRulesEnd
    }
    Tiempo_Extra_ExecuteBusinessRules(): void {
        //Tiempo_Extra_FieldExecuteBusinessRulesEnd
    }
    Aeronave_Propia_ExecuteBusinessRules(): void {
        //Aeronave_Propia_FieldExecuteBusinessRulesEnd
    }
  ...
  rulesOnInit() {
    ...
    if(  this.operation == 'New' || this.operation == 'Update' || this.operation == 'Consult' ) {
      this.brf.SetEnabledControl(this.Detalle_de_Actividades_de_ColaboradoresForm, 'Folio', 0);
      this.brf.SetEnabledControl(this.Detalle_de_Actividades_de_ColaboradoresForm, 'Empresa', 0);
      this.brf.SetEnabledControl(this.Detalle_de_Actividades_de_ColaboradoresForm, 'Puesto', 0);
    }

    if(  this.operation == 'New' ) {
      this.brf.SetCurrentDateToField(this.Detalle_de_Actividades_de_ColaboradoresForm,"Fecha_de_Reporte");

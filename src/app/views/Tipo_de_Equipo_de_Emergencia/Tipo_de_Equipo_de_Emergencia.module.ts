...
import { Tipo_de_Equipo_de_EmergenciaRoutingModule } from '../Tipo_de_Equipo_de_Emergencia/Tipo_de_Equipo_de_Emergencia-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Equipo_de_EmergenciaComponent,
    ListTipo_de_Equipo_de_EmergenciaComponent,
    ShowAdvanceFilterTipo_de_Equipo_de_EmergenciaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Equipo_de_EmergenciaRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Equipo_de_EmergenciaModule { }

...
import { Tipo_de_PilotoRoutingModule } from '../Tipo_de_Piloto/Tipo_de_Piloto-routing.module';
...
@NgModule({
  declarations: [Tipo_de_PilotoComponent,
    ListTipo_de_PilotoComponent,
    ShowAdvanceFilterTipo_de_PilotoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_PilotoModule { }

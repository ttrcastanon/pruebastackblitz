...
import { Estatus_de_facturacion_de_vueloRoutingModule } from '../Estatus_de_facturacion_de_vuelo/Estatus_de_facturacion_de_vuelo-routing.module';
...
@NgModule({
  declarations: [Estatus_de_facturacion_de_vueloComponent,
    ListEstatus_de_facturacion_de_vueloComponent,
    ShowAdvanceFilterEstatus_de_facturacion_de_vueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_facturacion_de_vueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_facturacion_de_vueloModule { }

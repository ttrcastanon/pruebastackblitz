...
import { Estatus_de_remocionRoutingModule } from '../Estatus_de_remocion/Estatus_de_remocion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_remocionComponent,
    ListEstatus_de_remocionComponent,
    ShowAdvanceFilterEstatus_de_remocionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_remocionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_remocionModule { }

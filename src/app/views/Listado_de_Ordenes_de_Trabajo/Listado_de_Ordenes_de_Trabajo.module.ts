...
import { Listado_de_Ordenes_de_TrabajoRoutingModule } from '../Listado_de_Ordenes_de_Trabajo/Listado_de_Ordenes_de_Trabajo-routing.module';
...
@NgModule({
  declarations: [Listado_de_Ordenes_de_TrabajoComponent,
    ListListado_de_Ordenes_de_TrabajoComponent,
    ShowAdvanceFilterListado_de_Ordenes_de_TrabajoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_de_Ordenes_de_TrabajoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_de_Ordenes_de_TrabajoModule { }

...
import { Tipo_Dia_NotificacionRoutingModule } from '../Tipo_Dia_Notificacion/Tipo_Dia_Notificacion-routing.module';
...
@NgModule({
  declarations: [Tipo_Dia_NotificacionComponent,
    ListTipo_Dia_NotificacionComponent,
    ShowAdvanceFilterTipo_Dia_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_Dia_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_Dia_NotificacionModule { }

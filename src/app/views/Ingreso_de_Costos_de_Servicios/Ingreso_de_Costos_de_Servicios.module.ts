...
import { Ingreso_de_Costos_de_ServiciosRoutingModule } from '../Ingreso_de_Costos_de_Servicios/Ingreso_de_Costos_de_Servicios-routing.module';
...
@NgModule({
  declarations: [Ingreso_de_Costos_de_ServiciosComponent,
    ListIngreso_de_Costos_de_ServiciosComponent,
    ShowAdvanceFilterIngreso_de_Costos_de_ServiciosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Ingreso_de_Costos_de_ServiciosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Ingreso_de_Costos_de_ServiciosModule { }

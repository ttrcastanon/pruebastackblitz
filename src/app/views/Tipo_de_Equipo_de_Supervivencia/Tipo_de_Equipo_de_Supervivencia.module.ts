...
import { Tipo_de_Equipo_de_SupervivenciaRoutingModule } from '../Tipo_de_Equipo_de_Supervivencia/Tipo_de_Equipo_de_Supervivencia-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Equipo_de_SupervivenciaComponent,
    ListTipo_de_Equipo_de_SupervivenciaComponent,
    ShowAdvanceFilterTipo_de_Equipo_de_SupervivenciaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Equipo_de_SupervivenciaRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Equipo_de_SupervivenciaModule { }

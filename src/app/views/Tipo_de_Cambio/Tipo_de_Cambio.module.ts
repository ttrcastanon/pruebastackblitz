...
import { Tipo_de_CambioRoutingModule } from '../Tipo_de_Cambio/Tipo_de_Cambio-routing.module';
...
@NgModule({
  declarations: [Tipo_de_CambioComponent,
    ListTipo_de_CambioComponent,
    ShowAdvanceFilterTipo_de_CambioComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_CambioModule { }

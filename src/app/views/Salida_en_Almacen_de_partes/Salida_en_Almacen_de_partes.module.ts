...
import { Salida_en_Almacen_de_partesRoutingModule } from '../Salida_en_Almacen_de_partes/Salida_en_Almacen_de_partes-routing.module';
...
@NgModule({
  declarations: [Salida_en_Almacen_de_partesComponent,
    ListSalida_en_Almacen_de_partesComponent,
    ShowAdvanceFilterSalida_en_Almacen_de_partesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Salida_en_Almacen_de_partesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Salida_en_Almacen_de_partesModule { }

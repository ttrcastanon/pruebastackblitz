...
import { Solicitudes_de_mantenimientos_externosRoutingModule } from '../Solicitudes_de_mantenimientos_externos/Solicitudes_de_mantenimientos_externos-routing.module';
...
@NgModule({
  declarations: [Solicitudes_de_mantenimientos_externosComponent,
    ListSolicitudes_de_mantenimientos_externosComponent,
    ShowAdvanceFilterSolicitudes_de_mantenimientos_externosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Solicitudes_de_mantenimientos_externosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Solicitudes_de_mantenimientos_externosModule { }

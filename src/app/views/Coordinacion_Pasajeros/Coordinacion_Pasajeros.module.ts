...
import { Coordinacion_PasajerosRoutingModule } from '../Coordinacion_Pasajeros/Coordinacion_Pasajeros-routing.module';
...
import { ModalCoordinacionPasajerosComponent } from './modal-coordinacion-pasajeros/modal-coordinacion-pasajeros.component';
...
@NgModule({
  declarations: [
    Coordinacion_PasajerosComponent,
    ListCoordinacion_PasajerosComponent,
    ShowAdvanceFilterCoordinacion_PasajerosComponent,
    ModalCoordinacionPasajerosComponent
  ],
  imports: [
    SharedModule,
    CommonModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Coordinacion_PasajerosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Coordinacion_PasajerosModule { }

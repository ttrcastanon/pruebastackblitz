...
@Component({
  selector: 'app-show-advance-filter-Coordinacion_Pasajeros',
  templateUrl: './show-advance-filter-Coordinacion_Pasajeros.component.html',
  styleUrls: ['./show-advance-filter-Coordinacion_Pasajeros.component.scss']
})
export class ShowAdvanceFilterCoordinacion_PasajerosComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Coordinacion_Pasajeros/list']);
  }
  ...
  buscar() {
	...
	this.dataListConfig.filterAdvanced.Notas_CFilter = entity.Notas_CFilter;
	this.dataListConfig.filterAdvanced.Notas_C = entity.Notas_C;

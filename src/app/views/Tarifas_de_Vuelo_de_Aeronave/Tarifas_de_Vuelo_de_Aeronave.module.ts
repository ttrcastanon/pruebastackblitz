...
import { Tarifas_de_Vuelo_de_AeronaveRoutingModule } from '../Tarifas_de_Vuelo_de_Aeronave/Tarifas_de_Vuelo_de_Aeronave-routing.module';
...
@NgModule({
  declarations: [Tarifas_de_Vuelo_de_AeronaveComponent,
    ListTarifas_de_Vuelo_de_AeronaveComponent,
    ShowAdvanceFilterTarifas_de_Vuelo_de_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tarifas_de_Vuelo_de_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tarifas_de_Vuelo_de_AeronaveModule { }

...
import { Tipo_de_AlaRoutingModule } from '../Tipo_de_Ala/Tipo_de_Ala-routing.module';
...
@NgModule({
  declarations: [Tipo_de_AlaComponent,
    ListTipo_de_AlaComponent,
    ShowAdvanceFilterTipo_de_AlaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_AlaModule { }

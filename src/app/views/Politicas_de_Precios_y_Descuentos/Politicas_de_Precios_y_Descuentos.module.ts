...
import { Politicas_de_Precios_y_DescuentosRoutingModule } from '../Politicas_de_Precios_y_Descuentos/Politicas_de_Precios_y_Descuentos-routing.module';
...
@NgModule({
  declarations: [Politicas_de_Precios_y_DescuentosComponent,
    ListPoliticas_de_Precios_y_DescuentosComponent,
    ShowAdvanceFilterPoliticas_de_Precios_y_DescuentosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Politicas_de_Precios_y_DescuentosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Politicas_de_Precios_y_DescuentosModule { }

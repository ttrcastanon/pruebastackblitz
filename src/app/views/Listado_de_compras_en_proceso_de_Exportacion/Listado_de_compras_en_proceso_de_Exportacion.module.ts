...
import { Listado_de_compras_en_proceso_de_ExportacionRoutingModule } from '../Listado_de_compras_en_proceso_de_Exportacion/Listado_de_compras_en_proceso_de_Exportacion-routing.module';
...
@NgModule({
  declarations: [Listado_de_compras_en_proceso_de_ExportacionComponent,
    ListListado_de_compras_en_proceso_de_ExportacionComponent,
    ShowAdvanceFilterListado_de_compras_en_proceso_de_ExportacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_de_compras_en_proceso_de_ExportacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_de_compras_en_proceso_de_ExportacionModule { }

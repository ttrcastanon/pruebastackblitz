...
@Component({
  selector: 'app-show-advance-filter-Listado_de_compras_en_proceso_de_Exportacion',
  templateUrl: './show-advance-filter-Listado_de_compras_en_proceso_de_Exportacion.component.html',
  styleUrls: ['./show-advance-filter-Listado_de_compras_en_proceso_de_Exportacion.component.scss']
})
export class ShowAdvanceFilterListado_de_compras_en_proceso_de_ExportacionComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Listado_de_compras_en_proceso_de_Exportacion/list']);
  }

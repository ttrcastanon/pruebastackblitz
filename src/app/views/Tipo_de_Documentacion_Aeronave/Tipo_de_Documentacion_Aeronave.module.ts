...
import { Tipo_de_Documentacion_AeronaveRoutingModule } from '../Tipo_de_Documentacion_Aeronave/Tipo_de_Documentacion_Aeronave-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Documentacion_AeronaveComponent,
    ListTipo_de_Documentacion_AeronaveComponent,
    ShowAdvanceFilterTipo_de_Documentacion_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Documentacion_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Documentacion_AeronaveModule { }

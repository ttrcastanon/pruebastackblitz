...
import { Configuracion_de_NotificacionRoutingModule } from '../Configuracion_de_Notificacion/Configuracion_de_Notificacion-routing.module';
...
@NgModule({
  declarations: [Configuracion_de_NotificacionComponent,
    ListConfiguracion_de_NotificacionComponent,
    ShowAdvanceFilterConfiguracion_de_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Configuracion_de_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Configuracion_de_NotificacionModule { }

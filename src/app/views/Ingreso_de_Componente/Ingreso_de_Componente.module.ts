...
import { Ingreso_de_ComponenteRoutingModule } from '../Ingreso_de_Componente/Ingreso_de_Componente-routing.module';
...
@NgModule({
  declarations: [Ingreso_de_ComponenteComponent,
    ListIngreso_de_ComponenteComponent,
    ShowAdvanceFilterIngreso_de_ComponenteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Ingreso_de_ComponenteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Ingreso_de_ComponenteModule { }

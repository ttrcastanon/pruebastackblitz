...
import { Razon_de_la_CompraRoutingModule } from '../Razon_de_la_Compra/Razon_de_la_Compra-routing.module';
...
@NgModule({
  declarations: [Razon_de_la_CompraComponent,
    ListRazon_de_la_CompraComponent,
    ShowAdvanceFilterRazon_de_la_CompraComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Razon_de_la_CompraRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Razon_de_la_CompraModule { }

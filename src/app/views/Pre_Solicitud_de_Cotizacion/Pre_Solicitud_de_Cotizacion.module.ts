...
import { Pre_Solicitud_de_CotizacionRoutingModule } from '../Pre_Solicitud_de_Cotizacion/Pre_Solicitud_de_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Pre_Solicitud_de_CotizacionComponent,
    ListPre_Solicitud_de_CotizacionComponent,
    ShowAdvanceFilterPre_Solicitud_de_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Pre_Solicitud_de_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Pre_Solicitud_de_CotizacionModule { }

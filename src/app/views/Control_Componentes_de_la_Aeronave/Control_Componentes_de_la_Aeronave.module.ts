...
import { Control_Componentes_de_la_AeronaveRoutingModule } from '../Control_Componentes_de_la_Aeronave/Control_Componentes_de_la_Aeronave-routing.module';
...
@NgModule({
  declarations: [Control_Componentes_de_la_AeronaveComponent,
    ListControl_Componentes_de_la_AeronaveComponent,
    ShowAdvanceFilterControl_Componentes_de_la_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Control_Componentes_de_la_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Control_Componentes_de_la_AeronaveModule { }

...
import { Solicitud_de_Pagos_de_Servicios_de_OperacionesRoutingModule } from '../Solicitud_de_Pagos_de_Servicios_de_Operaciones/Solicitud_de_Pagos_de_Servicios_de_Operaciones-routing.module';
...
@NgModule({
  declarations: [Solicitud_de_Pagos_de_Servicios_de_OperacionesComponent,
    ListSolicitud_de_Pagos_de_Servicios_de_OperacionesComponent,],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Solicitud_de_Pagos_de_Servicios_de_OperacionesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Solicitud_de_Pagos_de_Servicios_de_OperacionesModule { }

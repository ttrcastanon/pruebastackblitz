...
import { Tipos_de_CursoRoutingModule } from '../Tipos_de_Curso/Tipos_de_Curso-routing.module';
...
@NgModule({
  declarations: [Tipos_de_CursoComponent,
    ListTipos_de_CursoComponent,
    ShowAdvanceFilterTipos_de_CursoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipos_de_CursoModule { }

...
import { Control_de_Calibracion_de_Equipo_y_HerramientaRoutingModule } from '../Control_de_Calibracion_de_Equipo_y_Herramienta/Control_de_Calibracion_de_Equipo_y_Herramienta-routing.module';
...
@NgModule({
  declarations: [Control_de_Calibracion_de_Equipo_y_HerramientaComponent,
    ListControl_de_Calibracion_de_Equipo_y_HerramientaComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Control_de_Calibracion_de_Equipo_y_HerramientaRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Control_de_Calibracion_de_Equipo_y_HerramientaModule { }

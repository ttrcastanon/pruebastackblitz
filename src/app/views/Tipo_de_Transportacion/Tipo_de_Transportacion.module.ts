...
import { Tipo_de_TransportacionRoutingModule } from '../Tipo_de_Transportacion/Tipo_de_Transportacion-routing.module';
...
@NgModule({
  declarations: [Tipo_de_TransportacionComponent,
    ListTipo_de_TransportacionComponent,
    ShowAdvanceFilterTipo_de_TransportacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_TransportacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_TransportacionModule { }

...
import { Tipo_de_Condicion_ParteRoutingModule } from '../Tipo_de_Condicion_Parte/Tipo_de_Condicion_Parte-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Condicion_ParteComponent,
    ListTipo_de_Condicion_ParteComponent,
    ShowAdvanceFilterTipo_de_Condicion_ParteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Condicion_ParteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Condicion_ParteModule { }

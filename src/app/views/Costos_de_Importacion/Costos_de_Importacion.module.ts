...
import { Costos_de_ImportacionRoutingModule } from '../Costos_de_Importacion/Costos_de_Importacion-routing.module';
...
@NgModule({
  declarations: [Costos_de_ImportacionComponent,
    ListCostos_de_ImportacionComponent,
    ShowAdvanceFilterCostos_de_ImportacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Costos_de_ImportacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Costos_de_ImportacionModule { }

...
import { Estatus_de_Funcionalidad_para_NotificacionRoutingModule } from '../Estatus_de_Funcionalidad_para_Notificacion/Estatus_de_Funcionalidad_para_Notificacion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Funcionalidad_para_NotificacionComponent,
    ListEstatus_de_Funcionalidad_para_NotificacionComponent,
    ShowAdvanceFilterEstatus_de_Funcionalidad_para_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Funcionalidad_para_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Funcionalidad_para_NotificacionModule { }

...
import { Concepto_Balance_GeneralRoutingModule } from '../Concepto_Balance_General/Concepto_Balance_General-routing.module';
...
@NgModule({
  declarations: [Concepto_Balance_GeneralComponent,
    ListConcepto_Balance_GeneralComponent,
    ShowAdvanceFilterConcepto_Balance_GeneralComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Concepto_Balance_GeneralRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Concepto_Balance_GeneralModule { }

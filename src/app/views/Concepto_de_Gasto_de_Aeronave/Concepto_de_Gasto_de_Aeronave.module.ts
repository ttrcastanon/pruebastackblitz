...
import { Concepto_de_Gasto_de_AeronaveRoutingModule } from '../Concepto_de_Gasto_de_Aeronave/Concepto_de_Gasto_de_Aeronave-routing.module';
...
@NgModule({
  declarations: [Concepto_de_Gasto_de_AeronaveComponent,
    ListConcepto_de_Gasto_de_AeronaveComponent,
    ShowAdvanceFilterConcepto_de_Gasto_de_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Concepto_de_Gasto_de_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Concepto_de_Gasto_de_AeronaveModule { }

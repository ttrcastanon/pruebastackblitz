...
import { Notificaciones_de_mantenimientoRoutingModule } from '../Notificaciones_de_mantenimiento/Notificaciones_de_mantenimiento-routing.module';
...
@NgModule({
  declarations: [Notificaciones_de_mantenimientoComponent,
    ListNotificaciones_de_mantenimientoComponent,
    ShowAdvanceFilterNotificaciones_de_mantenimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Notificaciones_de_mantenimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Notificaciones_de_mantenimientoModule { }

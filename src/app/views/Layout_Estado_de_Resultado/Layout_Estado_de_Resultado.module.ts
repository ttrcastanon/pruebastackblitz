...
import { Layout_Estado_de_ResultadoRoutingModule } from '../Layout_Estado_de_Resultado/Layout_Estado_de_Resultado-routing.module';
...
@NgModule({
  declarations: [Layout_Estado_de_ResultadoComponent,
    ListLayout_Estado_de_ResultadoComponent,
    ShowAdvanceFilterLayout_Estado_de_ResultadoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Layout_Estado_de_ResultadoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Layout_Estado_de_ResultadoModule { }

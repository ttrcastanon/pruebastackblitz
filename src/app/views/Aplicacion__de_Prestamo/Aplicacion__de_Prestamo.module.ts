...
import { Aplicacion__de_PrestamoRoutingModule } from '../Aplicacion__de_Prestamo/Aplicacion__de_Prestamo-routing.module';
...
@NgModule({
  declarations: [Aplicacion__de_PrestamoComponent,
    ListAplicacion__de_PrestamoComponent,
    ShowAdvanceFilterAplicacion__de_PrestamoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Aplicacion__de_PrestamoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Aplicacion__de_PrestamoModule { }

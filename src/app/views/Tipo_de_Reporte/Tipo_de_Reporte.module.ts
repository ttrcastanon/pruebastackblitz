...
import { Tipo_de_ReporteRoutingModule } from '../Tipo_de_Reporte/Tipo_de_Reporte-routing.module';
...
@NgModule({
  declarations: [Tipo_de_ReporteComponent,
    ListTipo_de_ReporteComponent,
    ShowAdvanceFilterTipo_de_ReporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_ReporteModule { }

...
import { Tipo_de_BoletinRoutingModule } from '../Tipo_de_Boletin/Tipo_de_Boletin-routing.module';
...
@NgModule({
  declarations: [Tipo_de_BoletinComponent,
    ListTipo_de_BoletinComponent,
    ShowAdvanceFilterTipo_de_BoletinComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_BoletinModule { }

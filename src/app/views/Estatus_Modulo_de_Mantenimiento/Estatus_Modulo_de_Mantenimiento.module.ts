...
import { Estatus_Modulo_de_MantenimientoRoutingModule } from '../Estatus_Modulo_de_Mantenimiento/Estatus_Modulo_de_Mantenimiento-routing.module';
...
@NgModule({
  declarations: [Estatus_Modulo_de_MantenimientoComponent,
    ListEstatus_Modulo_de_MantenimientoComponent,
    ShowAdvanceFilterEstatus_Modulo_de_MantenimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_Modulo_de_MantenimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_Modulo_de_MantenimientoModule { }

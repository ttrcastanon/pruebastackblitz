...
import { Configuracion_de_Politicas_de_ViaticosRoutingModule } from '../Configuracion_de_Politicas_de_Viaticos/Configuracion_de_Politicas_de_Viaticos-routing.module';
...
@NgModule({
  declarations: [Configuracion_de_Politicas_de_ViaticosComponent,
    ListConfiguracion_de_Politicas_de_ViaticosComponent,
    ShowAdvanceFilterConfiguracion_de_Politicas_de_ViaticosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Configuracion_de_Politicas_de_ViaticosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Configuracion_de_Politicas_de_ViaticosModule { }

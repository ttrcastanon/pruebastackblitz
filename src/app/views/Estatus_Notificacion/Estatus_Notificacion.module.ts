...
import { Estatus_NotificacionRoutingModule } from '../Estatus_Notificacion/Estatus_Notificacion-routing.module';
...
@NgModule({
  declarations: [Estatus_NotificacionComponent,
    ListEstatus_NotificacionComponent,
    ShowAdvanceFilterEstatus_NotificacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_NotificacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_NotificacionModule { }

...
import { Tiempo_de_remocionRoutingModule } from '../Tiempo_de_remocion/Tiempo_de_remocion-routing.module';
...
@NgModule({
  declarations: [Tiempo_de_remocionComponent,
    ListTiempo_de_remocionComponent,
    ShowAdvanceFilterTiempo_de_remocionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tiempo_de_remocionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tiempo_de_remocionModule { }

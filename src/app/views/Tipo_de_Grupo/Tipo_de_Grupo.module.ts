...
import { Tipo_de_GrupoRoutingModule } from '../Tipo_de_Grupo/Tipo_de_Grupo-routing.module';
...
@NgModule({
  declarations: [Tipo_de_GrupoComponent,
    ListTipo_de_GrupoComponent,
    ShowAdvanceFilterTipo_de_GrupoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_GrupoModule { }

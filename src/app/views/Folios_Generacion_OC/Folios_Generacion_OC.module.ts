...
import { Folios_Generacion_OCRoutingModule } from '../Folios_Generacion_OC/Folios_Generacion_OC-routing.module';
...
@NgModule({
  declarations: [Folios_Generacion_OCComponent,
    ListFolios_Generacion_OCComponent,
    ShowAdvanceFilterFolios_Generacion_OCComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Folios_Generacion_OCRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Folios_Generacion_OCModule { }

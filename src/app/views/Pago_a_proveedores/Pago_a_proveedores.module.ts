...
import { Pago_a_proveedoresRoutingModule } from '../Pago_a_proveedores/Pago_a_proveedores-routing.module';
...
@NgModule({
  declarations: [Pago_a_proveedoresComponent,
    ListPago_a_proveedoresComponent,
    ShowAdvanceFilterPago_a_proveedoresComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Pago_a_proveedoresRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Pago_a_proveedoresModule { }

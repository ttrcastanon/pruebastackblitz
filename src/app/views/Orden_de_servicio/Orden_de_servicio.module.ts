...
import { Orden_de_servicioRoutingModule } from '../Orden_de_servicio/Orden_de_servicio-routing.module';
...
@NgModule({
  declarations: [Orden_de_servicioComponent,
    ListOrden_de_servicioComponent,
    ShowAdvanceFilterOrden_de_servicioComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Orden_de_servicioRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Orden_de_servicioModule { }

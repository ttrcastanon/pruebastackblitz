...
import { Estatus_de_Solicitud_de_Compras_GeneralesRoutingModule } from '../Estatus_de_Solicitud_de_Compras_Generales/Estatus_de_Solicitud_de_Compras_Generales-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Solicitud_de_Compras_GeneralesComponent,
    ListEstatus_de_Solicitud_de_Compras_GeneralesComponent,
    ShowAdvanceFilterEstatus_de_Solicitud_de_Compras_GeneralesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Solicitud_de_Compras_GeneralesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Solicitud_de_Compras_GeneralesModule { }

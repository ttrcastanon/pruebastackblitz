...
import { Estatus_de_Cierre_de_VueloRoutingModule } from '../Estatus_de_Cierre_de_Vuelo/Estatus_de_Cierre_de_Vuelo-routing.module';
...
@NgModule({
  declarations: [Estatus_de_Cierre_de_VueloComponent,
    ListEstatus_de_Cierre_de_VueloComponent,
    ShowAdvanceFilterEstatus_de_Cierre_de_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_Cierre_de_VueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_Cierre_de_VueloModule { }

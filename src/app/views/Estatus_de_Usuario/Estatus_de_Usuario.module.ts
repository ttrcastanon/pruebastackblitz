...
import { Estatus_de_UsuarioRoutingModule } from '../Estatus_de_Usuario/Estatus_de_Usuario-routing.module';
...
@NgModule({
  declarations: [Estatus_de_UsuarioComponent,
    ListEstatus_de_UsuarioComponent,
    ShowAdvanceFilterEstatus_de_UsuarioComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_UsuarioRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_UsuarioModule { }

...
import { Creacion_de_ClientesRoutingModule } from '../Creacion_de_Clientes/Creacion_de_Clientes-routing.module';
...
@NgModule({
  declarations: [Creacion_de_ClientesComponent,
    ListCreacion_de_ClientesComponent,
    ShowAdvanceFilterCreacion_de_ClientesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Creacion_de_ClientesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Creacion_de_ClientesModule { }

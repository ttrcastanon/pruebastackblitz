...
import { Categoria_de_PartesRoutingModule } from '../Categoria_de_Partes/Categoria_de_Partes-routing.module';
...
@NgModule({
  declarations: [Categoria_de_PartesComponent,
    ListCategoria_de_PartesComponent,
    ShowAdvanceFilterCategoria_de_PartesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Categoria_de_PartesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Categoria_de_PartesModule { }

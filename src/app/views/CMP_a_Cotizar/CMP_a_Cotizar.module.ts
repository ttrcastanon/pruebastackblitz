...
import { CMP_a_CotizarRoutingModule } from '../CMP_a_Cotizar/CMP_a_Cotizar-routing.module';
...
@NgModule({
  declarations: [CMP_a_CotizarComponent,
    ListCMP_a_CotizarComponent,
    ShowAdvanceFilterCMP_a_CotizarComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class CMP_a_CotizarModule { }

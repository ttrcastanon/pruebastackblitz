...
import { Toma_de_Tiempos_a_aeronavesRoutingModule } from '../Toma_de_Tiempos_a_aeronaves/Toma_de_Tiempos_a_aeronaves-routing.module';
...
@NgModule({
  declarations: [Toma_de_Tiempos_a_aeronavesComponent,
    ListToma_de_Tiempos_a_aeronavesComponent,
    ShowAdvanceFilterToma_de_Tiempos_a_aeronavesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Toma_de_Tiempos_a_aeronavesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Toma_de_Tiempos_a_aeronavesModule { }

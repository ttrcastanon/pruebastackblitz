...
import { Tipo_de_Orden_de_TrabajoRoutingModule } from '../Tipo_de_Orden_de_Trabajo/Tipo_de_Orden_de_Trabajo-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Orden_de_TrabajoComponent,
    ListTipo_de_Orden_de_TrabajoComponent,
    ShowAdvanceFilterTipo_de_Orden_de_TrabajoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Orden_de_TrabajoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Orden_de_TrabajoModule { }

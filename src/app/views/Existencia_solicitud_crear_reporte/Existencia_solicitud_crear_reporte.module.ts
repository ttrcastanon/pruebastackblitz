...
import { Existencia_solicitud_crear_reporteRoutingModule } from '../Existencia_solicitud_crear_reporte/Existencia_solicitud_crear_reporte-routing.module';
...
@NgModule({
  declarations: [Existencia_solicitud_crear_reporteComponent,
    ListExistencia_solicitud_crear_reporteComponent,
    ShowAdvanceFilterExistencia_solicitud_crear_reporteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Existencia_solicitud_crear_reporteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Existencia_solicitud_crear_reporteModule { }

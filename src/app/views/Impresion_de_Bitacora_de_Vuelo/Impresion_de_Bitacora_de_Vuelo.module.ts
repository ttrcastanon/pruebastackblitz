...
import { Impresion_de_Bitacora_de_VueloRoutingModule } from '../Impresion_de_Bitacora_de_Vuelo/Impresion_de_Bitacora_de_Vuelo-routing.module';
...
@NgModule({
  declarations: [Impresion_de_Bitacora_de_VueloComponent,
    ListImpresion_de_Bitacora_de_VueloComponent,
    ShowAdvanceFilterImpresion_de_Bitacora_de_VueloComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Impresion_de_Bitacora_de_VueloRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Impresion_de_Bitacora_de_VueloModule { }

...
import { Estatus_de_RequeridoRoutingModule } from '../Estatus_de_Requerido/Estatus_de_Requerido-routing.module';
...
@NgModule({
  declarations: [Estatus_de_RequeridoComponent,
    ListEstatus_de_RequeridoComponent,
    ShowAdvanceFilterEstatus_de_RequeridoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_RequeridoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_RequeridoModule { }

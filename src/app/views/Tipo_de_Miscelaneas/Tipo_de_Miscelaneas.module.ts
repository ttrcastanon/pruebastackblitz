...
import { Tipo_de_MiscelaneasRoutingModule } from '../Tipo_de_Miscelaneas/Tipo_de_Miscelaneas-routing.module';
...
@NgModule({
  declarations: [Tipo_de_MiscelaneasComponent,
    ListTipo_de_MiscelaneasComponent,
    ShowAdvanceFilterTipo_de_MiscelaneasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_MiscelaneasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_MiscelaneasModule { }

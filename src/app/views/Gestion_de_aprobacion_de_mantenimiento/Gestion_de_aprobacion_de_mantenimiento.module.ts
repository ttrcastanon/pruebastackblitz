...
import { Gestion_de_aprobacion_de_mantenimientoRoutingModule } from '../Gestion_de_aprobacion_de_mantenimiento/Gestion_de_aprobacion_de_mantenimiento-routing.module';
...
@NgModule({
  declarations: [Gestion_de_aprobacion_de_mantenimientoComponent,
    ListGestion_de_aprobacion_de_mantenimientoComponent,
    ShowAdvanceFilterGestion_de_aprobacion_de_mantenimientoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Gestion_de_aprobacion_de_mantenimientoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Gestion_de_aprobacion_de_mantenimientoModule { }

...
import { Layout_PresupuestosRoutingModule } from '../Layout_Presupuestos/Layout_Presupuestos-routing.module';
...
@NgModule({
  declarations: [Layout_PresupuestosComponent,
    ListLayout_PresupuestosComponent,
    ShowAdvanceFilterLayout_PresupuestosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Layout_PresupuestosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Layout_PresupuestosModule { }

...
import { Tipo_de_Notificacion_PushRoutingModule } from '../Tipo_de_Notificacion_Push/Tipo_de_Notificacion_Push-routing.module';
...
@NgModule({
  declarations: [Tipo_de_Notificacion_PushComponent,
    ListTipo_de_Notificacion_PushComponent,
    ShowAdvanceFilterTipo_de_Notificacion_PushComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipo_de_Notificacion_PushRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipo_de_Notificacion_PushModule { }

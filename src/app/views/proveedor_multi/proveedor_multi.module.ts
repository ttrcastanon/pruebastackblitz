...
import { proveedor_multiRoutingModule } from '../proveedor_multi/proveedor_multi-routing.module';
...
@NgModule({
  declarations: [proveedor_multiComponent,
    Listproveedor_multiComponent,
    ShowAdvanceFilterproveedor_multiComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class proveedor_multiModule { }

...
import { Equipo_de_NavegacionRoutingModule } from '../Equipo_de_Navegacion/Equipo_de_Navegacion-routing.module';
...
@NgModule({
  declarations: [Equipo_de_NavegacionComponent,
    ListEquipo_de_NavegacionComponent,
    ShowAdvanceFilterEquipo_de_NavegacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Equipo_de_NavegacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Equipo_de_NavegacionModule { }

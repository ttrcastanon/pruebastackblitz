...
import { Comparativo_de_Proveedores_ServiciosRoutingModule } from '../Comparativo_de_Proveedores_Servicios/Comparativo_de_Proveedores_Servicios-routing.module';
...
@NgModule({
  declarations: [Comparativo_de_Proveedores_ServiciosComponent,
    ListComparativo_de_Proveedores_ServiciosComponent,
    ShowAdvanceFilterComparativo_de_Proveedores_ServiciosComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Comparativo_de_Proveedores_ServiciosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Comparativo_de_Proveedores_ServiciosModule { }

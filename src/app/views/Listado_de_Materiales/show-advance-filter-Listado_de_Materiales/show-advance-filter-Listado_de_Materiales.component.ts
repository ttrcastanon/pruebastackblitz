...
@Component({
  selector: 'app-show-advance-filter-Listado_de_Materiales',
  templateUrl: './show-advance-filter-Listado_de_Materiales.component.html',
  styleUrls: ['./show-advance-filter-Listado_de_Materiales.component.scss']
})
export class ShowAdvanceFilterListado_de_MaterialesComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Listado_de_Materiales/list']);
  }

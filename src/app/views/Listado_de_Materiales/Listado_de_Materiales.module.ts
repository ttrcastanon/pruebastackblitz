...
import { Listado_de_MaterialesRoutingModule } from '../Listado_de_Materiales/Listado_de_Materiales-routing.module';
...
@NgModule({
  declarations: [Listado_de_MaterialesComponent,
    ListListado_de_MaterialesComponent,
    ShowAdvanceFilterListado_de_MaterialesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Listado_de_MaterialesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Listado_de_MaterialesModule { }

...
import { Solicitud_de_Servicios_para_OperacionesRoutingModule } from '../Solicitud_de_Servicios_para_Operaciones/Solicitud_de_Servicios_para_Operaciones-routing.module';
...
@NgModule({
  declarations: [Solicitud_de_Servicios_para_OperacionesComponent,
    ListSolicitud_de_Servicios_para_OperacionesComponent,
    ShowAdvanceFilterSolicitud_de_Servicios_para_OperacionesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Solicitud_de_Servicios_para_OperacionesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Solicitud_de_Servicios_para_OperacionesModule { }

...
import { Nombre_del_Campo_en_MSRoutingModule } from '../Nombre_del_Campo_en_MS/Nombre_del_Campo_en_MS-routing.module';
...
@NgModule({
  declarations: [Nombre_del_Campo_en_MSComponent,
    ListNombre_del_Campo_en_MSComponent,
    ShowAdvanceFilterNombre_del_Campo_en_MSComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Nombre_del_Campo_en_MSRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Nombre_del_Campo_en_MSModule { }

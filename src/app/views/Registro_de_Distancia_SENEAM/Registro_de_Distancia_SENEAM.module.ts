...
import { Registro_de_Distancia_SENEAMRoutingModule } from '../Registro_de_Distancia_SENEAM/Registro_de_Distancia_SENEAM-routing.module';
...
@NgModule({
  declarations: [Registro_de_Distancia_SENEAMComponent,
    ListRegistro_de_Distancia_SENEAMComponent,
    ShowAdvanceFilterRegistro_de_Distancia_SENEAMComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Registro_de_Distancia_SENEAMRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Registro_de_Distancia_SENEAMModule { }

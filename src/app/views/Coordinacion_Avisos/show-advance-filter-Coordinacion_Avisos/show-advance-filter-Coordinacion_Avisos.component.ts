...
@Component({
  selector: 'app-show-advance-filter-Coordinacion_Avisos',
  templateUrl: './show-advance-filter-Coordinacion_Avisos.component.html',
  styleUrls: ['./show-advance-filter-Coordinacion_Avisos.component.scss']
})
export class ShowAdvanceFilterCoordinacion_AvisosComponent implements OnInit, AfterViewInit {
  ...
  goToList() {
    this.router.navigate(['Coordinacion_Avisos/list']);
  }

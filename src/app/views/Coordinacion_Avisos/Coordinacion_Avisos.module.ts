...
import { Coordinacion_AvisosRoutingModule } from '../Coordinacion_Avisos/Coordinacion_Avisos-routing.module';
...
import { ModalCoordinacionAvisosComponent } from './modal-coordinacion-avisos/modal-coordinacion-avisos.component';
...
@NgModule({
  declarations: [
    Coordinacion_AvisosComponent,
    ListCoordinacion_AvisosComponent,
    ShowAdvanceFilterCoordinacion_AvisosComponent,
    ModalCoordinacionAvisosComponent
  ],
  imports: [
    SharedModule,
    CommonModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Coordinacion_AvisosRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Coordinacion_AvisosModule { }

...
import { Control_de_Componentes_de_la_AeronaveRoutingModule } from '../Control_de_Componentes_de_la_Aeronave/Control_de_Componentes_de_la_Aeronave-routing.module';
...
@NgModule({
  declarations: [Control_de_Componentes_de_la_AeronaveComponent,
    ListControl_de_Componentes_de_la_AeronaveComponent,
    ShowAdvanceFilterControl_de_Componentes_de_la_AeronaveComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Control_de_Componentes_de_la_AeronaveRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Control_de_Componentes_de_la_AeronaveModule { }

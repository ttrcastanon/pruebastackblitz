...
import { Gastos_de_VueloRoutingModule } from '../Gastos_de_Vuelo/Gastos_de_Vuelo-routing.module';
...
import { ModalGastosDeVueloComponent } from './modal-gastos-de-vuelo/modal-gastos-de-vuelo.component';
...
@NgModule({
  declarations: [
    Gastos_de_VueloComponent,
    ListGastos_de_VueloComponent,
    ShowAdvanceFilterGastos_de_VueloComponent,
    ModalGastosDeVueloComponent
  ],
  imports: [
    SharedModule,
    CommonModule,
...
export class Gastos_de_VueloModule { }

...
@Component({
  selector: 'app-modal-gastos-de-vuelo',
  templateUrl: './modal-gastos-de-vuelo.component.html',
  styleUrls: ['./modal-gastos-de-vuelo.component.scss'],
  animations: [
...
export class ModalGastosDeVueloComponent implements OnInit, AfterViewInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    public dialogRef: MatDialogRef<ModalGastosDeVueloComponent>,
  ...
  ngOnInit(): void {
    ...
    this._seguridad.permisos(AppConstants.Permisos.Gastos_de_Vuelo).subscribe((response) => {
  ...
  async saveData(): Promise<any> {
    ...
    if (this.rulesBeforeSave()) {
      ...
      if (this.model.Folio > 0) {
        await this.Gastos_de_VueloService.update(this.model.Folio, entity).toPromise().then(async id => {
  ...
  rulesOnInit() {
    ...
    this.brf.HideFieldOfForm(this.Gastos_de_VueloForm, "Folio");
    this.brf.SetNotRequiredControl(this.Gastos_de_VueloForm, "Folio");
    //TERMINA - BRID:2623

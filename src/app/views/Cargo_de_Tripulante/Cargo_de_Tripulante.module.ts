...
import { Cargo_de_TripulanteRoutingModule } from '../Cargo_de_Tripulante/Cargo_de_Tripulante-routing.module';
...
@NgModule({
  declarations: [Cargo_de_TripulanteComponent,
    ListCargo_de_TripulanteComponent,
    ShowAdvanceFilterCargo_de_TripulanteComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Cargo_de_TripulanteRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Cargo_de_TripulanteModule { }

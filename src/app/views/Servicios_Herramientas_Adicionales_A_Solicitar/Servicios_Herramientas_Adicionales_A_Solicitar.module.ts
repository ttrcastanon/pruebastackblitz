...
import { Servicios_Herramientas_Adicionales_A_SolicitarRoutingModule } from '../Servicios_Herramientas_Adicionales_A_Solicitar/Servicios_Herramientas_Adicionales_A_Solicitar-routing.module';
...
@NgModule({
  declarations: [Servicios_Herramientas_Adicionales_A_SolicitarComponent,
    ListServicios_Herramientas_Adicionales_A_SolicitarComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Servicios_Herramientas_Adicionales_A_SolicitarRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Servicios_Herramientas_Adicionales_A_SolicitarModule { }

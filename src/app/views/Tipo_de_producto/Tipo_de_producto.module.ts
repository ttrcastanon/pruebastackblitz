...
import { Tipo_de_productoRoutingModule } from '../Tipo_de_producto/Tipo_de_producto-routing.module';
...
@NgModule({
  declarations: [Tipo_de_productoComponent,
    ListTipo_de_productoComponent,
    ShowAdvanceFilterTipo_de_productoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_productoModule { }

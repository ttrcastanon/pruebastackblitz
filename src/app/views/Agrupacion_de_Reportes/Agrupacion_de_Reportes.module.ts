...
import { Agrupacion_de_ReportesRoutingModule } from '../Agrupacion_de_Reportes/Agrupacion_de_Reportes-routing.module';
...
@NgModule({
  declarations: [Agrupacion_de_ReportesComponent,
    ListAgrupacion_de_ReportesComponent,
    ShowAdvanceFilterAgrupacion_de_ReportesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Agrupacion_de_ReportesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Agrupacion_de_ReportesModule { }

...
import { Ingreso_a_almacenRoutingModule } from '../Ingreso_a_almacen/Ingreso_a_almacen-routing.module';
...
@NgModule({
  declarations: [Ingreso_a_almacenComponent,
    ListIngreso_a_almacenComponent,
    ShowAdvanceFilterIngreso_a_almacenComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Ingreso_a_almacenRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Ingreso_a_almacenModule { }

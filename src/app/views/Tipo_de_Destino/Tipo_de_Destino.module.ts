...
import { Tipo_de_DestinoRoutingModule } from '../Tipo_de_Destino/Tipo_de_Destino-routing.module';
...
@NgModule({
  declarations: [Tipo_de_DestinoComponent,
    ListTipo_de_DestinoComponent,
    ShowAdvanceFilterTipo_de_DestinoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
...
export class Tipo_de_DestinoModule { }

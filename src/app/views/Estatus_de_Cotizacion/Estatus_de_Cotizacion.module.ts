...
import { Estatus_de_CotizacionRoutingModule } from '../Estatus_de_Cotizacion/Estatus_de_Cotizacion-routing.module';
...
@NgModule({
  declarations: [Estatus_de_CotizacionComponent,
    ListEstatus_de_CotizacionComponent,
    ShowAdvanceFilterEstatus_de_CotizacionComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Estatus_de_CotizacionRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Estatus_de_CotizacionModule { }

...
import { Tipos_de_Modelo_CursoRoutingModule } from '../Tipos_de_Modelo_Curso/Tipos_de_Modelo_Curso-routing.module';
...
@NgModule({
  declarations: [Tipos_de_Modelo_CursoComponent,
    ListTipos_de_Modelo_CursoComponent,
    ShowAdvanceFilterTipos_de_Modelo_CursoComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Tipos_de_Modelo_CursoRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Tipos_de_Modelo_CursoModule { }

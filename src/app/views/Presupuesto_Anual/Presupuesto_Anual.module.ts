...
import { Presupuesto_AnualRoutingModule } from '../Presupuesto_Anual/Presupuesto_Anual-routing.module';
...
@NgModule({
  declarations: [Presupuesto_AnualComponent,
    ListPresupuesto_AnualComponent,
    ShowAdvanceFilterPresupuesto_AnualComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Presupuesto_AnualRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Presupuesto_AnualModule { }

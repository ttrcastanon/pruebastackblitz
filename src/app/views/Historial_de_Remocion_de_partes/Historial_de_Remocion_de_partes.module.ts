...
import { Historial_de_Remocion_de_partesRoutingModule } from '../Historial_de_Remocion_de_partes/Historial_de_Remocion_de_partes-routing.module';
...
@NgModule({
  declarations: [Historial_de_Remocion_de_partesComponent,
    ListHistorial_de_Remocion_de_partesComponent,
    ShowAdvanceFilterHistorial_de_Remocion_de_partesComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Historial_de_Remocion_de_partesRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Historial_de_Remocion_de_partesModule { }

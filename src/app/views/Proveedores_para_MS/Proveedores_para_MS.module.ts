...
import { Proveedores_para_MSRoutingModule } from '../Proveedores_para_MS/Proveedores_para_MS-routing.module';
...
@NgModule({
  declarations: [Proveedores_para_MSComponent,
    ListProveedores_para_MSComponent,
    ShowAdvanceFilterProveedores_para_MSComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Proveedores_para_MSRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Proveedores_para_MSModule { }

...
import { Comparativo_de_Proveedores_PiezasRoutingModule } from '../Comparativo_de_Proveedores_Piezas/Comparativo_de_Proveedores_Piezas-routing.module';
...
@NgModule({
  declarations: [Comparativo_de_Proveedores_PiezasComponent,
    ListComparativo_de_Proveedores_PiezasComponent,
    ShowAdvanceFilterComparativo_de_Proveedores_PiezasComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Comparativo_de_Proveedores_PiezasRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Comparativo_de_Proveedores_PiezasModule { }

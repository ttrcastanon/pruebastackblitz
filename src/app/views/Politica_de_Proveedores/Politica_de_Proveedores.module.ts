...
import { Politica_de_ProveedoresRoutingModule } from '../Politica_de_Proveedores/Politica_de_Proveedores-routing.module';
...
@NgModule({
  declarations: [Politica_de_ProveedoresComponent,
    ListPolitica_de_ProveedoresComponent,
    ShowAdvanceFilterPolitica_de_ProveedoresComponent],
  imports: [
    SharedModule,
    CommonModule,
    FormsModule,
    ...
    MatTooltipModule,
    MatMenuModule,
    Politica_de_ProveedoresRoutingModule,
    NgxSpinnerModule,
    MatRadioModule,
  ],
  providers: [
...
export class Politica_de_ProveedoresModule { }

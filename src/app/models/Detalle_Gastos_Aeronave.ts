...
import { Concepto_de_Gasto_de_Aeronave } from './Concepto_de_Gasto_de_Aeronave';
...
export class Detalle_Gastos_Aeronave  extends BaseView {
    ...
    @FormField('Concepto', [''])
    Concepto = null;
    Concepto_Concepto_de_Gasto_de_Aeronave: Concepto_de_Gasto_de_Aeronave;
    ...
    Observaciones = '';
     ...
     @FormField('Detalle_Gastos_Aeronaves', [''])
     Detalle_Gastos_Aeronaves: Detalle_Gastos_Aeronave[] = [];

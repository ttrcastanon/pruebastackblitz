...
export class Detalle_de_Agregar_Proveedor_Servicios  extends BaseView {
    @FormField('Folio', [0])
    Folio = 0;
    Comparativo_de_Proveedores_Piezas = 0;
    @FormField('Proveedor', [''])
    Proveedor = null;
    ...
    Seleccion_de_Proveedor = false;
     ...
     @FormField('Detalle_de_Agregar_Proveedor_Servicioss', [''])
     Detalle_de_Agregar_Proveedor_Servicioss: Detalle_de_Agregar_Proveedor_Servicios[] = [];

...
export class Detalle_Solicitud_de_Herramientas_Gestion_de_aprobacion  extends BaseView {
    @FormField('Folio', [0])
    Folio = 0;
    ...
    @FormField('FolioDetalleSolicitudHerramientas', [''])
    FolioDetalleSolicitudHerramientas = '';

     @FormField('Detalle_Solicitud_de_Herramientas_Gestion_de_aprobacions', [''])
     Detalle_Solicitud_de_Herramientas_Gestion_de_aprobacions: Detalle_Solicitud_de_Herramientas_Gestion_de_aprobacion[] = [];

...
export class Detalle_de_reportes_por_aeronave  extends BaseView {
    @FormField('Folio', [0])
    Folio = 0;
    ID_orden_de_servicio = 0;
    @FormField('Reporte', [''])
    Reporte = null;
    ...
    Notificado = null;
     ...
     @FormField('Detalle_de_reportes_por_aeronaves', [''])
     Detalle_de_reportes_por_aeronaves: Detalle_de_reportes_por_aeronave[] = [];
